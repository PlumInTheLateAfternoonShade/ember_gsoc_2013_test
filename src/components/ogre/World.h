...
namespace Ember
{
  ...
  namespace OgreView
  {
    ...
    public:
       ...
       */
      World(Eris::View& view, Ogre::RenderWindow& renderWindow,
          EmberOgreSignals& signals, Input& input, ShaderManager& shaderManager,
       ...
       */
      Authoring::EntityMoveManager&
      getMoveManager() const;
       ...
       */
      EmberEntity*
      getEmberEntity(const std::string& eid) const;
      ...
      getRenderDistanceManager() const;
    ...
    protected:
       ...
       */
      void
      terrainManager_AfterTerrainUpdate(
       ...
       */
      void
      View_gotAvatarCharacter(Eris::Entity* entity);
       ...
       */
      void
      updateEntityPosition(EmberEntity* entity,
          const std::vector<WFMath::AxisBox<2>>& areas);
       ...
       */
      void
      Config_Foliage(const std::string& section, const std::string& key,
       ...
       */
      void
      initializeFoliage(GraphicalChangeAdapter& graphicalChangeAdapter);
    };
    ...
    public:
       ...
       */
      DelayedFoliageInitializer(sigc::slot<void> callback, Eris::View& view,
          unsigned int intervalMs = 1000, unsigned int maxTimeMs = 15000);

      /**
       * @brief Dtor.
       */
      virtual
      ~DelayedFoliageInitializer();
    ...
    inline Authoring::EntityMoveManager&
    World::getMoveManager() const
    {
      return *mMoveManager;
    }
