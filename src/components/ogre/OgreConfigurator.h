...
namespace Ember
{
  namespace OgreView
  {
    ...
    public:
       ...
       */
      std::string
      getChosenRenderSystemName() const;
    ...
    protected:
      ...
      bool
      buttonOkClicked(const CEGUI::EventArgs& args);
      bool
      buttonCancelClicked(const CEGUI::EventArgs& args);
      bool
      buttonAdvancedClicked(const CEGUI::EventArgs& args);
      bool
      renderSystemChanged(const CEGUI::EventArgs& args);
      void
      updateResolutionList(Ogre::RenderSystem* renderSystem);
