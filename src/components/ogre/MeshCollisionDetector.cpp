...
namespace Ember
{
  namespace OgreView
  {
    ...
    void
    MeshCollisionDetector::reload()
    {
    }

    void
    MeshCollisionDetector::refit()
    {
    }

    void
    MeshCollisionDetector::setVisualize(bool visualize)
    {
    }
    bool
    MeshCollisionDetector::getVisualize() const
    {
      return false;
    }

    void
    MeshCollisionDetector::testCollision(Ogre::Ray& ray,
        CollisionResult& result)
    {
      ...
      for (Model::Model::SubModelSet::const_iterator I = submodels.begin();
          I != submodels.end(); ++I)
        {
...
// Code found on this forum link: http://www.ogre3d.org/wiki/index.php/RetrieveVertexData
    void
    MeshCollisionDetector::getMeshInformation(const Ogre::MeshPtr mesh,
