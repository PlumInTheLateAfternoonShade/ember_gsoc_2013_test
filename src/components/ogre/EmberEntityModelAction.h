...
namespace Ember
{
  ...
  namespace OgreView
  {
    ...
    {
    public:
      EmberEntityModelAction(EmberEntity& entity, const std::string& modelName,
          Scene& scene, EntityMapping::EntityMapping& mMapping);
      virtual
      ~EmberEntityModelAction();

      virtual void
      activate(EntityMapping::ChangeContext& context);
      virtual void
      deactivate(EntityMapping::ChangeContext& context);
