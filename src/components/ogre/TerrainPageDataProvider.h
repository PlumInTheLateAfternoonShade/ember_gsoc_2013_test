...
namespace Ember
{
  namespace OgreView
  {
    ...
    public:
      ...
      virtual
      ~TerrainPageDataProvider();

      virtual IPageData*
      getPageData(const OgreIndex& ogreIndexPosition);
      virtual int
      getPageIndexSize() const;
      virtual void
      setUpTerrainPageAtIndex(const OgreIndex& ogreIndexPosition,
          Terrain::ITerrainPageBridge* bridge);
      virtual void
      removeBridge(const OgreIndex& ogreIndexPosition);
    ...
    protected:
       ...
       */
      Domain::TerrainIndex
      convertToWFTerrainIndex(const OgreIndex& ogreIndexPosition);
