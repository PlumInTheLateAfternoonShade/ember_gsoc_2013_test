...
namespace Ember
{
  namespace OgreView
  {
    ...
    public:
       ...
       */
      void
      registerEntityWithTechnique(EmberEntity& entity,
       ...
       */
      void
      deregisterEntityWithTechnique(EmberEntity& entity,
          const std::string& technique);
       ...
       */
      void
      addRenderingTechnique(const std::string& name,
      ...
      removeRenderingTechnique(const std::string& name);

      void
      registerPageDataProvider(IPageDataProvider* pageDataProvider);
