...
namespace Forests
{
  ...
  public:
    ...
    public:
      ...
      void
      addSubEntity(Ogre::SubEntity *ent, const Ogre::Vector3 &position,
      ...
      void
      setMaterial(Ogre::MaterialPtr &mat)
      {
        material = mat;
      }
      void
      setMaterialName(const Ogre::String &mat)
      {
      ...
      void
      addSelfToRenderQueue(Ogre::RenderQueue *queue, Ogre::uint8 group);
      void
      getRenderOperation(Ogre::RenderOperation& op);
      Ogre::Real
      getSquaredViewDepth(const Ogre::Camera* cam) const;
      const Ogre::LightList&
      getLights(void) const;
      ...
      void
      getWorldTransforms(Ogre::Matrix4* xform) const
      {
        *xform = parent->_getParentNodeFullTransform();
      }
      const Ogre::Quaternion&
      getWorldOrientation(void) const
      {
        return parent->sceneNode->_getDerivedOrientation();
      }
      const Ogre::Vector3&
      getWorldPosition(void) const
      {
    ...
    private:
      ...
      Ogre::Material *
      getMaterialClone(Ogre::Material &mat);
  ...
  protected:
    static void
    extractVertexDataFromShared(Ogre::MeshPtr mesh);

    Ogre::String
    getFormatString(Ogre::SubEntity *ent);
