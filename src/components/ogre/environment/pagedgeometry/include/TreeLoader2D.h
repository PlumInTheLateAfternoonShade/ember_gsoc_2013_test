...
namespace Forests
{
  ...
  public:
    ...
    void
    addTree(Ogre::Entity *entity, const Ogre::Vector3 &position,
     ...
     */
    void
    setHeightFunction(Ogre::Real
    (*heightFunction)(Ogre::Real x, Ogre::Real z, void *userData),
        void *userData = NULL)
    {
    ...
    void
    setColorMap(const Ogre::String &mapFile,
    ...
    void
    setColorMap(Ogre::TexturePtr map, MapChannel channel = CHANNEL_COLOR);
    ...
    void
    setColorMapFilter(MapFilter filter)
    {
    ...
    void
    setMaximumScale(Ogre::Real maxScale)
    {
    ...
    /** \brief Sets the minimum tree scale value
     ...
     the size of the currently added trees to change. */
    void
    setMinimumScale(Ogre::Real minScale)
    {
  ...
  private:
    ...
    //Height data
    Ogre::Real
    (*heightFunction)(Ogre::Real x, Ogre::Real z, void *userData);//Pointer to height function
    ...
    inline std::vector<TreeDef> &
    _getGridPage(std::vector<TreeDef> *grid, int x, int z)
    {
#ifdef _DEBUG
    ...
    inline void
    _setGridPage(std::vector<TreeDef> *grid, int x, int z,
