...
namespace Forests
{
  ...
  public:
    ...
    virtual void
    init(PagedGeometry *geom, const Ogre::Any &data);
    ~BatchPage();
    ...
    void
    setFade(bool enabled, Ogre::Real visibleDist, Ogre::Real invisibleDist);
  ...
  private:
    static inline Ogre::String
    getUniqueID(const Ogre::String &prefix)
    {
