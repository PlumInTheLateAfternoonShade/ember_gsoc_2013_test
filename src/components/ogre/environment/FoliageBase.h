  ...
  namespace OgreView
  {
    ...
    namespace Environment
    {
      ...
      public:
        ...
        void
        reloadAtPosition(const WFMath::Point<2>& worldPosition);
      ...
      protected:
        ...
        void
        TerrainHandler_LayerUpdated(const Terrain::TerrainShader* shader,
            const Terrain::AreaStore& areas);
        void
        TerrainHandler_EventShaderCreated(const Terrain::TerrainShader& shader);
        void
        TerrainHandler_AfterTerrainUpdate(
      ...
      float
      getTerrainHeight(float x, float z, void* userData = 0);
      double
      getTerrainHeight(double x, double z, void* userData = 0);
