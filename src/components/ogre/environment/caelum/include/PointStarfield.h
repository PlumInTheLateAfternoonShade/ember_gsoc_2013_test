...
namespace Caelum
{
  ...
  public:
     ...
     */
    PointStarfield(Ogre::SceneManager *sceneMgr,
        Ogre::SceneNode *caelumRootNode, bool initWithCatalogue = true);
  ...
  public:
     ...
     */
    inline void
    setMagnitudeScale(Ogre::Real value)
    {
      mMagnitudeScale = value;
    }
    inline Ogre::Real
    getMagnitudeScale() const
    {
      return mMagnitudeScale;
    }

    inline void
    setMag0PixelSize(Ogre::Real value)
    {
      mMag0PixelSize = value;
    }
    inline Ogre::Real
    getMag0PixelSize() const
    {
      return mMag0PixelSize;
    }

    inline void
    setMinPixelSize(Ogre::Real value)
    {
      mMinPixelSize = value;
    }
    inline Ogre::Real
    ...
    inline void
    setMaxPixelSize(Ogre::Real value)
    {
      mMaxPixelSize = value;
    }
    inline Ogre::Real
    ...
    void
    setObserverLatitude(Ogre::Degree value);
    inline Ogre::Degree
    getObserverLatitude() const
    {
      return mObserverLatitude;
    }

    void
    setObserverLongitude(Ogre::Degree value);
    inline Ogre::Degree
    getObserverLongitude() const
    {
      return mObserverLongitude;
    }
  ...
  public:
     ...
     */
    inline Ogre::Degree
    getObserverPositionRebuildDelta() const
    {
      return mObserverPositionRebuildDelta;
    }
    inline void
    setObserverPositionRebuildDelta(Ogre::Degree value)
    {
    ...
    virtual void
    notifyCameraChanged(Ogre::Camera *cam);

  protected:
    /// Handle far radius.
    virtual void
    setFarRadius(Ogre::Real radius);

  public:
    void
    setQueryFlags(uint flags)
    {
      mManualObj->setQueryFlags(flags);
    }
    uint
    getQueryFlags() const
    {
      return mManualObj->getQueryFlags();
    }
    void
    setVisibilityFlags(uint flags)
    {
      mManualObj->setVisibilityFlags(flags);
    }
    uint
    getVisibilityFlags() const
    {
      return mManualObj->getVisibilityFlags();
    }
  ...
  private:
    ...
    {
      void
      setup(Ogre::GpuProgramParametersSharedPtr vpParams);
