...
namespace Caelum
{
  ...
  public:
     ...
     */
    void
    loadCaelumSystemFromScript(CaelumSystem* sys,
        const Ogre::String& objectName, const Ogre::String& scriptFileGroup =
    ...
    {
      return &mPropScriptResourceManager;
    }
    CaelumScriptTranslatorManager*
    getScriptTranslatorManager()
    {
      return &mScriptTranslatorManager;
    }
