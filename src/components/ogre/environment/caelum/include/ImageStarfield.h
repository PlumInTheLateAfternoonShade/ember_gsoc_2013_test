...
namespace Caelum
{
  ...
  public:
     ...
     */
    ImageStarfield(Ogre::SceneManager *sceneMgr,
        Ogre::SceneNode *caelumRootNode, const Ogre::String &textureName =
     ...
     */
    void
    setInclination(Ogre::Degree inc);
     ...
     */
    void
    setTexture(const Ogre::String &mapName);
