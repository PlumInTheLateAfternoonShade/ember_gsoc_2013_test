    ...
    namespace Environment
    {
      ...
      public:
        ...
        Environment(Ogre::SceneManager& sceneMgr,
            ...
            IEnvironmentProvider* fallbackProvider = 0);
         ...
         */
        void
        setFirmamentEnabled(bool enabled);
         ...
         */
        void
        setAmbientLight(const Ogre::ColourValue& colour);
      ...
      inline IWater*
      Environment::getWater()
      {
        return mProvider->getWater();
      }

      inline Forest*
      Environment::getForest()
      {
        return mForest;
      }
