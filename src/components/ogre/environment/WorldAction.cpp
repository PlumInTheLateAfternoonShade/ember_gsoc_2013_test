...
namespace Ember
{
  namespace OgreView
  {
    namespace Environment
    {
      ...
      void
      WorldAction::activate(EntityMapping::ChangeContext& context)
      {
            ...
            if (Environment* environment = world->getEnvironment())
              {
                ...
                WorldRepresentation* world = new WorldRepresentation(mEntity,
                    *environment);
              ...
              {
                S_LOG_WARNING(
                    "Tried to activate world representation, but there was no environment instance available.");
              }
          }
      }

      void
      WorldAction::deactivate(EntityMapping::ChangeContext& context)
      {
