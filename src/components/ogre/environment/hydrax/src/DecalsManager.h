...
namespace Hydrax
{
  ...
  public:
     ...
     */
    void
    setPosition(const Ogre::Vector2& Position);

    /** Set decal size
     @param Size Decal size in world coordinates
     */
    void
    setSize(const Ogre::Vector2& Size);

    /** Set decal orientation
     @param Orientation Decal orientation
     */
    void
    setOrientation(const Ogre::Radian& Orientation);
     ...
     */
    void
    setTransparency(const Ogre::Real& Transparency);
  ...
  public:
     ...
     */
    Decal*
    add(const Ogre::String& TextureName);
     ...
     */
    inline void
    _setWaterStrength(const Ogre::Real &WaterStrength)
    {
