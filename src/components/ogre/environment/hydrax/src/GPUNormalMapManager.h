...
namespace Hydrax
{
  ...
  public:
     ...
     */
    inline Ogre::TexturePtr &
    getTexture(const int& Index)
    {
     ...
     */
    void
    addTexture(Ogre::TexturePtr &Texture)
    {
  ...
  private:
    typedef std::vector<Ogre::TexturePtr,
        Ogre::STLAllocator<Ogre::TexturePtr,
            Ogre::CategorisedAlignAllocPolicy<Ogre::MEMCATEGORY_GENERAL>> > TextureStore;
