...
namespace Hydrax
{
  namespace Noise
  {
    Noise::Noise(const Ogre::String &Name, const bool& GPUNormalMapSupported) :
        mName(Name), mCreated(false), mGPUNormalMapSupported(
            GPUNormalMapSupported), mGPUNormalMapResourcesCreated(false)
    {
    }
    ...
    bool
    Noise::createGPUNormalMapResources(GPUNormalMapManager *g)
    {
    ...
    void
    Noise::removeGPUNormalMapResources(GPUNormalMapManager *g)
    {
      if (mGPUNormalMapSupported && mGPUNormalMapResourcesCreated)
        {
    ...
    void
    Noise::saveCfg(Ogre::String &Data)
    {
      Data += "#Noise options\n";
      Data += "Noise=" + mName + "\n\n";
    }
    ...
    bool
    Noise::loadCfg(const Ogre::ConfigFile &CfgFile)
    {
