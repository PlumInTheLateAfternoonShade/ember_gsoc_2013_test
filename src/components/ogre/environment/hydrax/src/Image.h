...
namespace Hydrax
{
  ...
  public:
    ...
    enum Type
    {
      TYPE_ONE_CHANNEL = 1, TYPE_TWO_CHANNELS = 2, TYPE_RGB = 3,
      /// Default
      TYPE_RGBA = 4
    };
     ...
     */
    const float&
    getValue(const int &x, const int &y, const int &c) const;
     ...
     */
    float
    getValueLI(const float &x, const float &y, const int &c) const;
     ...
     */
    inline const float&
    getValue(const int &x, const int &y, const Channel &c) const
    {
     ...
     */
    inline float
    getValueLI(const float &x, const float &y, const Channel &c) const
    {
     ...
     */
    Pixel
    getPixelLI(const float &x, const float &y) const;
     ...
     */
    void
    setValue(const int &x, const int &y, const int &c, const float &v);
     ...
     */
    inline void
    setValue(const int &x, const int &y, const Channel &c, const float &v)
    {
     ...
     */
    void
    setPixel(const int &x, const int &y, const Pixel &p);
