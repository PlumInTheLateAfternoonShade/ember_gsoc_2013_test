...
namespace Ember
{
  namespace OgreView
  {
    ...
    namespace Environment
    {
      ...
      {
      public:
        CaelumEnvironment(Ogre::SceneManager *sceneMgr,
        ...
        virtual void
        setTimeMultiplier(float multiplier);
         ...
         */
        virtual void
        setWorldPosition(float longitudeDegrees, float latitudeDegrees);
      ...
      private:
         ...
         */
        void
        setupCaelum(Ogre::SceneManager *sceneMgr, Ogre::RenderWindow* window,
            Ogre::Camera& camera);
      ...
      inline Caelum::CaelumSystem*
      CaelumEnvironment::getCaelumSystem() const
      {
      ...
      protected:
        CaelumEnvironmentComponent(CaelumEnvironment& environment) :
            mEnvironment(environment), mCaelumSystem(
                environment.getCaelumSystem())
        {
        }
