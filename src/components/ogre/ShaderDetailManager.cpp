...
namespace Ember
{
  namespace OgreView
  {
    ...
    ShaderDetailManager::ShaderDetailManager(
        ...
        mShaderThresholdLevel(8.0f), mGraphicalChangeAdapter(
            graphicalChangeAdapter), mShaderManager(shaderManager)
    {
...
//	mChangeRequiredConnection.disconnect();
    ...
    bool
    ShaderDetailManager::stepUpShaderLevel()
    {
    ...
    bool
    ShaderDetailManager::stepDownShaderLevel()
    {
      ShaderManager::GraphicsLevel level;
    ...
    void
    ShaderDetailManager::pause()
    {
      mChangeRequiredConnection.block();
    }

    void
    ShaderDetailManager::unpause()
    {
