  ...
  namespace OgreView
  {
    ...
    namespace Gui
    {
      ...
      public:
         ...
         */
        void
        showBuildingBlock(const std::string & spec);
         ...
         */
        void
        selectAttachPoint(const Carpenter::AttachPoint* point);
      ...
      protected:
        ...
        bool
        Zoom_ValueChanged(const CEGUI::EventArgs& args);
      ...
      {
      public:
        JesusEditFile(GUIManager* guiManager, JesusEdit* jesusEdit,
            Jesus* jesus);
        ~JesusEditFile();
      ...
      protected:
        ...
        bool
        Load_Click(const CEGUI::EventArgs& args);
        bool
        Save_Click(const CEGUI::EventArgs& args);
        ...
        bool
        saveBluePrint(const std::string& name, Carpenter::BluePrint* blueprint);
      ...
      public:
         ...
         */
        void
        loadConstruction(Construction* construction);
         ...
         */
        Construction*
        createNewConstructionFromBlueprint(Carpenter::BluePrint* blueprint);
      ...
      protected:
         ...
         */
        bool
        SwitchMode_Click(const CEGUI::EventArgs& args);
         ...
         */
        bool
        Bind_Click(const CEGUI::EventArgs& args);
         ...
         */
        bool
        Create_Click(const CEGUI::EventArgs& args);
         ...
         */
        bool
        CreateNew_Click(const CEGUI::EventArgs& args);
         ...
         */
        bool
        Remove_Click(const CEGUI::EventArgs& args);

        bool
        File_Click(const CEGUI::EventArgs& args);

        bool
        AvailableBlocksList_SelectionChanged(const CEGUI::EventArgs& args);
        bool
        CurrentBlocksList_SelectionChanged(const CEGUI::EventArgs& args);
        bool
        CurrentPointsList_SelectionChanged(const CEGUI::EventArgs& args);
        bool
        NewPointsList_SelectionChanged(const CEGUI::EventArgs& args);
         ...
         */
        const Carpenter::AttachPoint*
        getSelectedPointForCurrentBlock() const;
        /**
         *    gets the selected AttachPoint for the new
         * @return null if no block selected
         */
        const Carpenter::AttachPoint*
        getSelectedPointForNewBlock() const;
         ...
         */
        void
        pickedModelBlock(ModelBlock* modelBlock, const MousePickerArgs&);
         ...
         */
        void
        pickedAttachPointNode(AttachPointNode* pointNode,
            const MousePickerArgs&);
         ...
         */
        void
        fillAttachPointList(ModelBlock* block);
         ...
         */
        void
        fillNewAttachPointList(const Carpenter::BlockSpec* blockspec);
         ...
         * @return 
         */
        std::vector<Carpenter::BuildingBlockBinding*>
        createBindingsForNewBlock(Carpenter::BuildingBlock* newBlock);
...
// 	Carpenter::BlockSpec* getNewBlockSpec();
        const Carpenter::BuildingBlockSpec*
        getNewBuildingBlockSpec() const;
        /**
...
//	void createPreviewTexture();
      ...
      inline ModelBlock*
      JesusEdit::getSelectedBlock()
      {
        return mCurrentlySelectedBlock;
      }
      ;
      inline Construction*
      JesusEdit::getConstruction() const
      {
        return mCurrentConstruction;
      }
