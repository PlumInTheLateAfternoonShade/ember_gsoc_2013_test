...
namespace Ember
{
  namespace OgreView
  {
    ...
    namespace Gui
    {
      ...
      {
        container->subscribeEvent(CEGUI::Window::EventDragDropItemEnters,
            CEGUI::Event::Subscriber(
                &ActionBarIconDragDropTarget::dragContainer_DragEnter, this));
        container->subscribeEvent(CEGUI::Window::EventDragDropItemLeaves,
            CEGUI::Event::Subscriber(
                &ActionBarIconDragDropTarget::dragContainer_DragLeave, this));
        container->subscribeEvent(CEGUI::Window::EventDragDropItemDropped,
            CEGUI::Event::Subscriber(
                &ActionBarIconDragDropTarget::dragContainer_DragDropped, this));
      ...
      bool
      ActionBarIconDragDropTarget::dragContainer_DragEnter(
      ...
      bool
      ActionBarIconDragDropTarget::dragContainer_DragLeave(
          const CEGUI::EventArgs& args)
      {
        ActionBarIcon* actionBarIcon = parseIcon(args);
        if (actionBarIcon)
      ...
      bool
      ActionBarIconDragDropTarget::handleDragEnter(const CEGUI::EventArgs& args,
          ActionBarIcon* icon)
      {
      ...
      bool
      ActionBarIconDragDropTarget::handleDragLeave(const CEGUI::EventArgs& args,
          ActionBarIcon* icon)
      {
      ...
      bool
      ActionBarIconDragDropTarget::handleDragActionBarIconDropped(
          const CEGUI::EventArgs& args, ActionBarIcon* icon)
      {
        EventActionBarIconDropped.emit(icon);
        return true;
      }
      bool
      ActionBarIconDragDropTarget::handleDragEntityIconDropped(
          const CEGUI::EventArgs& args, EntityIcon* icon)
      {
      ...
      ActionBarIcon*
      ActionBarIconDragDropTarget::parseIcon(const CEGUI::EventArgs& args)
      {
        const boost::any* anyData = getUserData(args);
        if (anyData)
          {
      ...
      const boost::any*
      ActionBarIconDragDropTarget::getUserData(
          const CEGUI::EventArgs& args) const
      {
