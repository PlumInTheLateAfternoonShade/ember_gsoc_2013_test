...
namespace Ember
{
  namespace OgreView
  {
    ...
    namespace Gui
    {
        ...
        mConnections.push_back(
            container->subscribeEvent(CEGUI::Window::EventDragDropItemEnters,
                CEGUI::Event::Subscriber(
                    &EntityIconDragDropTarget::dragContainer_DragEnter, this)));
        mConnections.push_back(
            container->subscribeEvent(CEGUI::Window::EventDragDropItemLeaves,
                CEGUI::Event::Subscriber(
                    &EntityIconDragDropTarget::dragContainer_DragLeave, this)));
        mConnections.push_back(
            container->subscribeEvent(CEGUI::Window::EventDragDropItemDropped,
                CEGUI::Event::Subscriber(
                    &EntityIconDragDropTarget::dragContainer_DragDropped,
                    this)));
      }
      ...
      bool
      EntityIconDragDropTarget::dragContainer_DragEnter(
      ...
      bool
      EntityIconDragDropTarget::dragContainer_DragLeave(
          const CEGUI::EventArgs& args)
      {
        EntityIcon* entityIcon = parseIcon(args);
        if (entityIcon)
      ...
      bool
      EntityIconDragDropTarget::handleDragEnter(const CEGUI::EventArgs& args,
          EntityIcon* icon)
      {
      ...
      bool
      EntityIconDragDropTarget::handleDragLeave(const CEGUI::EventArgs& args,
          EntityIcon* icon)
      {
      ...
      bool
      EntityIconDragDropTarget::handleDragDropped(const CEGUI::EventArgs& args,
          EntityIcon* icon)
      {
      ...
      EntityIcon*
      EntityIconDragDropTarget::parseIcon(const CEGUI::EventArgs& args)
      {
        ...
        if (container)
          {
            const boost::any* anyData =
                static_cast<const boost::any*>(container->getUserData());
