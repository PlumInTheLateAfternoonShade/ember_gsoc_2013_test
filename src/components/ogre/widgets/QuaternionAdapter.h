...
namespace Ember
{
  namespace OgreView
  {
    ...
    namespace Gui
    {
      ...
      {
      public:
        QuaternionAdapter(CEGUI::Window *degreeWindow, CEGUI::Window *xWindow,
            CEGUI::Window *yWindow, CEGUI::Window *zWindow,
            const Ogre::Quaternion& quaternion = Ogre::Quaternion::ZERO);
         ...
         */
        void
        setValue(const Ogre::Quaternion& quaternion);

        /**
         Updates the gui with new values.
         */
        void
        updateGui(const Ogre::Quaternion& vector);
