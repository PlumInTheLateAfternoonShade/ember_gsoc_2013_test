  ...
  namespace OgreView
  {
    ...
    namespace Gui
    {
      ...
      protected:
         ...
         */
        virtual bool
        handleDragEnter(const CEGUI::EventArgs& args, ActionBarIcon* icon);
         ...
         */
        virtual bool
        handleDragLeave(const CEGUI::EventArgs& args, ActionBarIcon* icon);
         ...
         */
        virtual bool
        handleDragActionBarIconDropped(const CEGUI::EventArgs& args,
            ActionBarIcon* icon);
         ...
         */
        virtual bool
        handleDragEntityIconDropped(const CEGUI::EventArgs& args,
            EntityIcon* icon);
      ...
      private:
         ...
         */
        bool
        dragContainer_DragEnter(const CEGUI::EventArgs& args);
         ...
         */
        bool
        dragContainer_DragLeave(const CEGUI::EventArgs& args);
         ...
         */
        bool
        dragContainer_DragDropped(const CEGUI::EventArgs& args);
         ...
         */
        ActionBarIcon*
        parseIcon(const CEGUI::EventArgs& args);
         ...
         */
        const boost::any*
        getUserData(const CEGUI::EventArgs& args) const;
