      ...
      namespace Representations
      {
        ...
        template<typename ValueType>
          ...
          public:
             ...
             */
            virtual void
            addSuggestion(const std::string& suggestion) = 0;
          };
