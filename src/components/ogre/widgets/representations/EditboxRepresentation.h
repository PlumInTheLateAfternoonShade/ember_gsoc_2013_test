    ...
    namespace Gui
    {
      ...
      namespace Representations
      {
        ...
        template<typename ValueType, typename PropertyNativeType>
          class EditboxRepresentation : public SingleAdapterRepresentationBase<
              ValueType>
          {
          public:
            /**
             ...
             */
            virtual
            ~EditboxRepresentation();

            virtual CEGUI::Window*
            getGuiRoot();
        ...
        template<typename ValueType, typename PropertyNativeType>
          ...
          {
            mLayout = LayoutHelper::loadLayout(
                "representations/EditboxRepresentation.layout", mPrefix);

            this->setAdapter(
                new Adapters::GenericPropertyAdapter<ValueType,
                    PropertyNativeType>(value,
        ...
        template<typename ValueType, typename PropertyNativeType>
          CEGUI::Window*
          EditboxRepresentation<ValueType, PropertyNativeType>::getGuiRoot()
          {
            return mLayout;
          }
