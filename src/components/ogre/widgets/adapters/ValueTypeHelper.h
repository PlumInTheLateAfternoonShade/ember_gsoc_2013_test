      ...
      namespace Adapters
      {
        ...
        template<typename ValueType>
          struct CompareHelper
          {
             ...
             */
            static bool
            areEqual(const ValueType& one, const ValueType& two)
            {
              return one == two;
            }
        ...
        template<>
          ...
          {
            static bool
            areEqual(const varconf::Variable& one,
                const varconf::Variable& two);
          };
        ...
        template<>
          ...
          {
            static std::string
            convert(const ::Atlas::Message::Element& v)
            {
              return v.asString();
            }
          };
        ...
        template<>
          ...
          {
            static std::string
            convert(const ::varconf::Variable& v)
            {
              return v.as_string();
            }
          };
