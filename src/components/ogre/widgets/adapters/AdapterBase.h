      ...
      namespace Adapters
      {
        ...
        template<typename ValueType>
          ...
          public:
             ...
             */
            void
            setValue(const ValueType& element);
             ...
             */
            virtual void
            updateGui(const ValueType& element) = 0;
             ...
             */
            virtual void
            addSuggestion(const std::string& suggestedValue);

            /**
             * @brief Internal method, use SelfUpdateContext instead where possible!
             */
            void
            _setSelfUpdate(bool selfUpdate);
          ...
          protected:
             ...
             */
            void
            addGuiEventConnection(CEGUI::Event::Connection connection);
        ...
        template<typename ValueType>
          AdapterBase<ValueType>::AdapterBase(const ValueType& value) :
              mOriginalValue(value), mEditedValue(value), mSelfUpdate(false), mRemoved(
                  false)
          {
          }
        ...
        template<typename ValueType>
          void
          AdapterBase<ValueType>::setValue(const ValueType& element)
          {
            updateGui(element);
            EventValueChanged.emit();
          }
        ...
        template<typename ValueType>
          const ValueType&
          AdapterBase<ValueType>::getValue()
          {
            fillElementFromGui();
            return mEditedValue;
          }
        ...
        template<typename ValueType>
          const ValueType&
          AdapterBase<ValueType>::getOriginalValue() const
          {
        ...
        template<typename ValueType>
          void
          AdapterBase<ValueType>::applyChanges()
          {
            if (!mRemoved)
              {
                _applyChanges();
        ...
        template<typename ValueType>
          bool
          AdapterBase<ValueType>::hasChanges()
          {
            if (mRemoved)
              {
                return true;
        ...
        template<typename ValueType>
          ValueType
          AdapterBase<ValueType>::getChangedElement()
          {
            if (mRemoved)
              {
                return ValueType();
        ...
        template<typename ValueType>
          bool
          AdapterBase<ValueType>::isRemoved() const
          {
            return mRemoved;
          }
        ...
        template<typename ValueType>
          void
          AdapterBase<ValueType>::addSuggestion(
        ...
        template<typename ValueType>
          void
          AdapterBase<ValueType>::_setSelfUpdate(bool selfUpdate)
          {
        ...
        template<typename ValueType>
          void
          AdapterBase<ValueType>::_applyChanges()
          {
        ...
        template<typename ValueType>
          bool
          AdapterBase<ValueType>::_hasChanges()
          {
            return !CompareHelper<ValueType>::areEqual(mOriginalValue,
                getValue());
          }

        template<typename ValueType>
          ValueType
          AdapterBase<ValueType>::_getChangedElement()
          {
            return getValue();
          }
        ...
        template<typename ValueType>
          void
          AdapterBase<ValueType>::addGuiEventConnection(
        ...
        template<typename ValueType>
          void
          AdapterBase<ValueType>::disconnectAllGuiEventConnections()
          {
            for (std::vector<CEGUI::Event::Connection>::iterator I =
                mGuiEventConnections.begin(); I != mGuiEventConnections.end();
                ++I)
              {
                (*I)->disconnect();
              }
