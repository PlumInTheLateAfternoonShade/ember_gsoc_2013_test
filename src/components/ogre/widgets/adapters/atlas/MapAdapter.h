      ...
      namespace Adapters
      {
        ...
        namespace Atlas
        {
          ...
          public:
            ...
            MapAdapter(const ::Atlas::Message::Element& element,
                CEGUI::Window* childContainer);
            ...
            valueOfAttr(const std::string& attr) const;
            bool
            hasAttr(const std::string& attr) const;
            ...
            void
            addAttributeAdapter(const std::string& attributeName,
             ...
             */
            bool
            hasAdapter(const std::string& attr) const;
