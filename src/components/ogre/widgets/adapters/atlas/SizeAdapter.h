    ...
    namespace Gui
    {
      ...
      namespace Adapters
      {
        ...
        namespace Atlas
        {
          ...
          {
          public:
            SizeAdapter(const ::Atlas::Message::Element& element,
                CEGUI::Window* lowerXWindow, CEGUI::Window* lowerYWindow,
                CEGUI::Window* lowerZWindow, CEGUI::Window* upperXWindow,
                CEGUI::Window* upperYWindow, CEGUI::Window* upperZWindow,
                CEGUI::Slider* scaler, CEGUI::Window* infoWindow);
             ...
             */
            virtual void
            updateGui(const ::Atlas::Message::Element& element);
          ...
          protected:
            ...
            bool
            window_TextChanged(const CEGUI::EventArgs& e);
            bool
            slider_ValueChanged(const CEGUI::EventArgs& e);
