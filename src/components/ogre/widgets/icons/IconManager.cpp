    ...
    namespace Gui
    {
      ...
      namespace Icons
      {
        ...
        public:
          ...
          virtual void
          createActions(EntityMapping::EntityMapping& modelMapping,
              EntityMapping::Cases::CaseBase*,
        ...
        Icon*
        IconManager::getIcon(int, EmberEntity* entity)
        {
          ...
          else
            {
              ...
              std::unique_ptr<EntityMapping::EntityMapping> modelMapping(
                  Mapping::EmberEntityMappingManager::getSingleton().getManager().createMapping(
                      *entity, actionCreator,
                      &EmberOgre::getSingleton().getWorld()->getView()));
              ...
              Ogre::ResourcePtr modelDefPtr =
                  Model::ModelDefinitionManager::getSingleton().getByName(
                      modelName);
              if (!modelDefPtr.isNull())
                {
                  Model::ModelDefinition* modelDef =
                      static_cast<Model::ModelDefinition*>(modelDefPtr.get());
                      ...
                      try
                        {
                          if (Ogre::TextureManager::getSingleton().resourceExists(
                            ...
                            {
                              texPtr =
                                  static_cast<Ogre::TexturePtr>(Ogre::TextureManager::getSingleton().getByName(
                                      iconPath));
                        ...
                        {
                          S_LOG_WARNING(
                              "Error when trying to load the icon " << iconPath <<". The icon will be rendered dynamically.");
                          texPtr.setNull();
                        }
                      if (!texPtr.isNull())
                        {
        ...
        Icon*
        IconManager::getIcon(int, Eris::TypeInfo* erisType)
        {
        ...
        void
        IconManager::render(Icon& icon, EmberEntity& entity)
        {
          IconActionCreator actionCreator(entity);
          std::unique_ptr<EntityMapping::EntityMapping> modelMapping(
              Mapping::EmberEntityMappingManager::getSingleton().getManager().createMapping(
        ...
        void
        IconManager::render(Icon& icon, Eris::TypeInfo& erisType)
        {
        ...
        void
        IconManager::render(Icon& icon, const std::string& modelName)
        {
