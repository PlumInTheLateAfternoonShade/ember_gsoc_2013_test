  ...
  namespace OgreView
  {
    ...
    namespace Gui
    {
      ...
      namespace Icons
      {
        ...
        {
        public:
          DelayedIconRendererEntry(DelayedIconRendererWorker& renderer,
              Model::Model* model, Icon* icon);
          virtual
          ~DelayedIconRendererEntry();
          /**
        ...
        public:
           ...
           */
          virtual void
          render(Model::Model* model, Icon* icon,
              IconImageStoreEntry* imageStoreEntry) = 0;
        protected:
         ...
         */
        class DelayedIconRendererWorker : public Ogre::FrameListener,
            public IconRenderWorker
        {
        ...
        public:
          ...
          void
          render(Model::Model* model, Icon* icon,
              IconImageStoreEntry* imageStoreEntry);
        ...
        protected:
           ...
           */
          void
          performRendering(DelayedIconRendererEntry& entry);
           ...
           */
          void
          finalizeRendering(DelayedIconRendererEntry& entry);
        ...
        public:
           ...
           */
          void
          render(const std::string& modelName, Icon* icon);
           ...
           */
          void
          setWorker(IconRenderWorker* worker);
           ...
           */
          void
          performRendering(Model::Model* model, Icon* icon);
        ...
        protected:
           ...
           */
          void
          renderDelayed(Model::Model* model, Icon* icon);
        };
