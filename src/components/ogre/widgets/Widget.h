...
// };
      ...
      public:
         ...
         */
        CEGUI::Window*
        getWindow(const std::string& windowName, bool throwIfNotFound = false);
         ...
         */
        void
        registerConsoleVisibilityToggleCommand(
         ...
         */
        CEGUI::Window*
        loadMainSheet(const std::string& filename, const std::string& prefix);
         ...
         */
        void
        setIsActiveWindowOpaque(bool isOpaque);
         ...
         */
        void
        addTabbableWindow(CEGUI::Window* window);
         ...
         */
        void
        addEnterButton(CEGUI::Window* window);
      ...
      protected:
        ...
        bool
        MainWindow_CloseClick(const CEGUI::EventArgs& args);

        bool
        MainWindow_Activated(const CEGUI::EventArgs& args);
        bool
        MainWindow_Deactivated(const CEGUI::EventArgs& args);
        bool
        MainWindow_MouseButtonDown(const CEGUI::EventArgs& args);
        /**
         ...
         */
        bool
        MainWindow_Shown(const CEGUI::EventArgs& args);
        ...
        bool
        TabbableWindow_KeyDown(const CEGUI::EventArgs& args);
      ...
      public:
         ...
         */
        static void
        registerWidgetFactory(const std::string& name, FactoryFunc functor);

        static void
        removeAllWidgetFactories();
