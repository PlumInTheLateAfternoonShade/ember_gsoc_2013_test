  ...
  namespace OgreView
  {
    ...
    namespace Gui
    {
      ...
      protected:
        ...
        void
        createdAccount(Eris::Account* account);
        void
        gotAvatar(Eris::Avatar* avatar);
        void
        avatar_Deactivated(bool clean);

        bool
        Login_Click(const CEGUI::EventArgs& args);
        bool
        LogoutButton_Click(const CEGUI::EventArgs& args);
        bool
        Choose_Click(const CEGUI::EventArgs& args);
        bool
        UseCreator_Click(const CEGUI::EventArgs& args);
        bool
        CreateChar_Click(const CEGUI::EventArgs& args);
        bool
        CreateAcc_Click(const CEGUI::EventArgs& args);
        bool
        OkButton_Click(const CEGUI::EventArgs& args);
        bool
        Disconnect_Click(const CEGUI::EventArgs& args);

        bool
        TeleportYes_Click(const CEGUI::EventArgs& args);
        bool
        TeleportNo_Click(const CEGUI::EventArgs& args);

        bool
        fetchCredentials(Eris::Connection* connection, std::string& user,
            std::string& pass);
        bool
        saveCredentials(void);
        void
        loginSuccess(Eris::Account* account);
        void
        logoutComplete(bool clean);

        /**
         * Shows the error message sent from Eris if the login does not succeed.
         */
        void
        showLoginFailure(Eris::Account* account, std::string msg);
         ...
         */
        bool
        nameBox_TextChanged(const CEGUI::EventArgs& args);

        /**
         * This function is a slot reacting on a ChangeEvent in the password box.
         */
        bool
        passwordBox_TextChanged(const CEGUI::EventArgs& args);
        void
        gotAllCharacters(Eris::Account* account);

        bool
        TypesList_SelectionChanged(const CEGUI::EventArgs& args);
        bool
        Gender_SelectionChanged(const CEGUI::EventArgs& args);
        bool
        Name_TextChanged(const CEGUI::EventArgs& args);
        bool
        Description_TextChanged(const CEGUI::EventArgs& args);
         ...
         */
        void
        fillAllowedCharacterTypes(Eris::Account* account);
         ...
         */
        void
        connection_GotServerInfo(Eris::Connection* connection);

        void
        setConnection(Eris::Connection* connection);
         ...
         */
        void
        showServerInfo(Eris::Connection* connection);
