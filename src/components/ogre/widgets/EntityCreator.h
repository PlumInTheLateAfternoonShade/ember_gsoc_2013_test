  ...
  namespace OgreView
  {
    ...
    namespace Gui
    {
      ...
      public:
         ...
         */
        void
        setRecipe(Authoring::EntityRecipe& recipe);
         ...
         */
        void
        setRandomizeOrientation(bool randomize);
