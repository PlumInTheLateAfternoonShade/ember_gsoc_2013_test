  ...
  namespace OgreView
  {
    namespace Gui
    {
      ...
      public:
         ...
         */
        void
        addItem(CEGUI::ListboxItem* item);
        /**
         ...
         */
        void
        insertItem(CEGUI::ListboxItem* item,
         ...
         */
        void
        removeItem(const CEGUI::ListboxItem* item);
        /**
      ...
      protected:
         ...
         */
        bool
        isItemAllowed(CEGUI::ListboxItem* item);

        bool
        filterEditbox_TextChanged(const CEGUI::EventArgs& args);
