  ...
  namespace OgreView
  {
    ...
    namespace Gui
    {
      ...
      public:
         ...
         */
        AttachPointHelper(Model::Model& model,
      ...
      public:
         ...
         */
        EntityAttachPointHelper(Model::Model& model,
      ...
      public:
         ...
         */
        ModelAttachPointHelper(Model::Model& model,
      ...
      public:
         ...
         */
        AttachPointMouseMover(AttachPointHelper& attachPointHelper,
            Model::ModelDefinitionPtr modelDefinition,
            SimpleRenderContext& renderContext);

        virtual
        ~AttachPointMouseMover()
        {
        }

        virtual void
        injectMouseMove(const MouseMotion& motion, bool& freezeMouse) = 0;
         ...
         */
        virtual bool
        injectMouseButtonUp(const Input::MouseButton& button) = 0;
      protected:
      ...
      public:
         ...
         * @param renderContext The render context which contains the model.
         */
        RotateMouseMover(AttachPointHelper& attachPointHelper,
            Model::ModelDefinitionPtr modelDefinition,
            SimpleRenderContext& renderContext);
        virtual void
        injectMouseMove(const MouseMotion& motion, bool& freezeMouse);
        virtual bool
        injectMouseButtonUp(const Input::MouseButton& button);
      };
      ...
      public:
         ...
         * @param renderContext The render context which contains the model.
         */
        TranslateMouseMover(AttachPointHelper& attachPointHelper,
            Model::ModelDefinitionPtr modelDefinition,
            SimpleRenderContext& renderContext);
        virtual void
        injectMouseMove(const MouseMotion& motion, bool& freezeMouse);
      ...
      public:
         ...
         */
        void
        showAttachPointHelperEntity(const std::string& attachPointName,
            const std::string& meshName =
                "3d_objects/primitives/models/arrow.mesh");
         ...
         */
        void
        showAttachPointHelperModel(const std::string& attachPointName,
        ...
        injectMouseButtonUp(const Input::MouseButton& button);
        virtual bool
        injectMouseButtonDown(const Input::MouseButton& button);
        virtual bool
        injectChar(int character);
        virtual bool
        injectKeyDown(const SDLKey& key);
        virtual bool
        injectKeyUp(const SDLKey& key);
