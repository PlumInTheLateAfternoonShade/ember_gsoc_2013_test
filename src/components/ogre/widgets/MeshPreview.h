  ...
  namespace OgreView
  {
    namespace Gui
    {
      ...
      public:
         ...
         */
        size_t
        createInstance(const std::string& meshName);
         ...
         * @return 
         */
        MeshPreviewMeshInstance&
        getInstance(size_t position);
         ...
         */
        void
        updateAnimation(Ogre::Real elapsedTime);
      ...
      public:
         ...
         */
        void
        startAnimation(const std::string& name);
         ...
         */
        void
        stopAnimation(const std::string& name);
         ...
         */
        void
        toggleAnimation(const std::string& name);
         ...
         */
        bool
        isAnimationPlaying(const std::string& name);
         ...
         */
        bool
        isAnimationEnabled(const std::string& name);
...
//  	void loadAllAvailableMeshes();
        ...
        void
        createdNewEntity(size_t index);
        void
        removedEntity(size_t index);

        bool
        createButton_Click(const CEGUI::EventArgs& args);
        bool
        removeButton_Click(const CEGUI::EventArgs& args);
        bool
        playAnimation_Clicked(const CEGUI::EventArgs& args);
        bool
        resetAnimation_Clicked(const CEGUI::EventArgs& args);

// 	void addMeshToAvailableMeshesList(const std::string& name);

        bool
        createdMeshes_EventSelectionChanged(const CEGUI::EventArgs& args);

        bool
        Scale_ValueChanged(const CEGUI::EventArgs& args);
        ...
        void
        fillAnimationList(MeshPreviewMeshInstance& instance);
