  ...
  namespace OgreView
  {
    ...
    namespace Gui
    {
      ...
      public:
         ...
         */
        EntityEditor(World& world, Eris::Entity& entity,
            Adapters::Atlas::MapAdapter* rootAdapter);
         ...
         */
        void
        addGoal(const std::string& verb, const std::string& definition);
         ...
         */
        void
        addKnowledge(const std::string& predicate, const std::string& subject,
         ...
         */
        void
        addMarker(const WFMath::Point<3>& point);
         ...
         */
        static WFMath::Point<3>
        createPoint(float x, float y, float z);
