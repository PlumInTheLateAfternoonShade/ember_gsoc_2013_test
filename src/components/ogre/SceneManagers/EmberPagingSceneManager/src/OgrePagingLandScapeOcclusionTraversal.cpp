...
namespace Ogre
{
  //-----------------------------------------------------------------------
  void
  ConstTraversalConst::traverseChildren(const PagingLandScapeOctree& node,
  ...
  //-----------------------------------------------------------------------
  void
  TraversalConst::traverseChildren(PagingLandScapeOctree& node,
      VisibleObjectsBoundsInfo * const visibleBounds) const
  {
    if (!node.mNodes.empty())
      {
  ...
  //-----------------------------------------------------------------------
  void
  Traversal::traverseChildren(PagingLandScapeOctree& node,
