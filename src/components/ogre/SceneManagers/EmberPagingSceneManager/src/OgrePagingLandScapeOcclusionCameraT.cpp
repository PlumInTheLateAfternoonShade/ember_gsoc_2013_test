...
namespace Ogre
{
  //-----------------------------------------------------------------------
  void
  RegisterCameraTraversal::onTree(PagingLandScapeOctree& n,
  ...
  //-----------------------------------------------------------------------
  void
  RegisterCameraTraversal::onLeaf(PagingLandScapeOctreeNode& n,
      VisibleObjectsBoundsInfo * const visibleBounds) const
  {
    n.addCamNodeData(cam);
  }
  //-----------------------------------------------------------------------
  void
  UnregisterCameraTraversal::onTree(PagingLandScapeOctree& n,
      VisibleObjectsBoundsInfo * const visibleBounds) const
  {
  ...
  //-----------------------------------------------------------------------
  void
  UnregisterCameraTraversal::onLeaf(PagingLandScapeOctreeNode& n,
      VisibleObjectsBoundsInfo * const visibleBounds) const
  {
    n.removeCamNodeData(cam);
  }
