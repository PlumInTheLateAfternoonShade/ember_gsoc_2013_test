...
//---------------------------------------------------------------------
  PagingLandScapeOctreeRaySceneQuery::PagingLandScapeOctreeRaySceneQuery(
...
//---------------------------------------------------------------------
  void
  PagingLandScapeOctreeRaySceneQuery::execute(RaySceneQueryListener* listener)
  {
            ...
            while (oit.hasMoreElements())
              {
                ...
                if ((m->getQueryFlags() & mQueryMask) && m->isInScene())
                  {
                    std::pair<bool, Real> result = mRay.intersects(
