...
namespace Ogre
{
  ...
  public:
    RegisterCameraTraversal(PagingLandScapeOctreeCamera *c) :
        cam(c)
    {
    }
    ;
    virtual void
    onTree(PagingLandScapeOctree& n,
        VisibleObjectsBoundsInfo * const visibleBounds) const;
    virtual void
    onLeaf(PagingLandScapeOctreeNode& n,
        VisibleObjectsBoundsInfo * const visibleBounds) const;
  };
  //-----------------------------------------------------------------------
  // 
  ...
  public:
    UnregisterCameraTraversal(PagingLandScapeOctreeCamera *c) :
        cam(c)
    {
    }
    ;
