...
namespace Ogre
{
  ...
  public:
    ...
    void
    setParent(PagingLandScapeOctree * parent);
    void
    setSceneManager(PagingLandScapeOctreeSceneManager * scn);
     ...
     */
    void
    _addNode(PagingLandScapeOctreeNode* nod);

    /** Removes an PagingLandScapeOctree scene node to this PagingLandScapeOctree level.
     */
    void
    _removeNode(PagingLandScapeOctreeNode* nod);
     ...
     */
    bool
    _isTwiceSize(const AxisAlignedBox& box) const;
     ...
     */
    bool
    _isTwiceCullSize(const AxisAlignedBox& box) const;

    bool
    _isNotCrossingAxes(const AxisAlignedBox& box) const;
     ...
     */
    PagingLandScapeOctree*
    _getChildWhereBoxFits(const AxisAlignedBox& bx,
     ...
     */
    PagingLandScapeOctree *
    _getCullChildWhereBoxFits(const AxisAlignedBox& bx,
        PagingLandScapeOctreeSceneManager *scn);
     ...
     */
    void
    _getCullBounds(AxisAlignedBox* bound) const;
    ...
    inline void
    traversal(Traversal &tr, VisibleObjectsBoundsInfo * const visibleBounds)
    {
      tr.onTree(*this, visibleBounds);
    }
    ;
    inline void
    traversal(const TraversalConst &tr,
    ...
    ;
    inline void
    traversal(const ConstTraversalConst &tr,
        VisibleObjectsBoundsInfo * const visibleBounds) const
    {
      tr.onTree(*this, visibleBounds);
    }
    ;
    ...
    ;
    inline const Vector3 &
    getCullHalfSize() const
    {
      return mCullHalfSize;
    }
    ;
  ...
  protected:
     ...
     */
    void
    _unref(const bool removeChildren);
