...
namespace Ogre
{
  ...
  public:
    ...
    bool
    load(DataStreamPtr& stream);
    bool
    load(const String &filename, ConfigFile& config);
    bool
    load(const String &filename);

    void
    loadMap(const String& mapName);
    void
    loadMapOptions(DataStreamPtr &stream);
    void
    insertMap(const String& mapName);

    LandScapeFileNames*
    getLandScapeFileNames(void)
    {
      return &mMapList;
    }
    ;
    ...
    bool
    hasOption(const String& strKey) const;

    bool
    getOptionValues(const String & key, StringVector &refValueList);
    bool
    getOptionKeys(StringVector &refKeys);
    ...
    const String&
    getMapFilename(const String &currMapName) const;
    const String&
    getPreviousMapName(void) const;
    const String&
    getNextMapName(void) const;
    const String&
    getCurrentMapName(void) const;

    void
    setCurrentMapName(const String& mapName);

    const String&
    getCurrentTextureFormat(void) const;
    void
    setTextureFormat(const String& format);
    void
    insertTextureFormat(const String &format);

    void
    setPrimaryCamera(PagingLandScapeCamera* cam);
    void
    calculateCFactor(void);
    ...
    bool
    setUint(unsigned int &u, const String &ValuetoGet);
    bool
    setBool(bool &b, const String &ValuetoGet);
    bool
    setReal(Real &r, const String &ValuetoGet);
    bool
    setColourValue(ColourValue &r, const String &ValuetoGet);
    bool
    setString(String &s, const String &ValuetoGet);
    ...
    void
    setTileInfo(PagingLandScapeTileInfo *t);
    PagingLandScapeTileInfo *
    getTileInfo(const uint pageX, const uint pageZ, const uint tileX,
        const uint tileZ);
    void
    loadMapInfo();
    void
  ...
  private:
    ...
    void
    loadcfg(const String &filename, ConfigFile& config);
    ColourValue
    _getAvgColor(const String& tex) const;
    String mCurrentMap;
