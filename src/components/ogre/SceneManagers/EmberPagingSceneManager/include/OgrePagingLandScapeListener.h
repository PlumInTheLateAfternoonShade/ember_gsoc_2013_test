...
namespace Ogre
{
  ...
  public:
     ...
     */
    virtual void
    pagePreloaded(size_t pagex, size_t pagez, const Real* heightData,
        const AxisAlignedBox& Bbox)
    {
    }
    virtual void
    pageLoaded(size_t pagex, size_t pagez, const Real* heightData,
        const AxisAlignedBox& Bbox)
    {
    }
    virtual void
    pageUnloaded(size_t pagex, size_t pagez, const Real* heightData,
        const AxisAlignedBox& Bbox)
    {
    }
    virtual void
    pagePostunloaded(size_t pagex, size_t pagez)
    {
    }
    virtual void
    pageShow(size_t pagex, size_t pagez, const Real* heightData,
        const AxisAlignedBox& Bbox)
    {
    }
    virtual void
    pageHide(size_t pagex, size_t pagez, const Real* heightData,
        const AxisAlignedBox& Bbox)
    {
    }
    virtual void
    tileLoaded(size_t pagex, size_t pagez, size_t tilex, size_t tilez,
        const AxisAlignedBox& Bbox)
    {
    }
    virtual void
    tileUnloaded(size_t pagex, size_t pagez, size_t tilex, size_t tilez,
        const AxisAlignedBox& Bbox)
    {
    }
    virtual void
    tileDeformed(size_t pagex, size_t pagez, size_t tilex, size_t tilez,
        const AxisAlignedBox& Bbox)
    {
    }
    virtual void
    tileShow(size_t pagex, size_t pagez, size_t tilex, size_t tilez,
        const AxisAlignedBox& Bbox)
    {
    }
    virtual void
    tileHide(size_t pagex, size_t pagez, size_t tilex, size_t tilez,
        const AxisAlignedBox& Bbox)
    {
    }
    virtual void
