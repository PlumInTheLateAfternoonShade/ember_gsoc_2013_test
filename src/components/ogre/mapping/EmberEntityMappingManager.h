...
namespace Ember
{
  namespace OgreView
  {
    ...
    namespace Mapping
    {
       ...
       */
      class EmberEntityMappingManager : public Ogre::ResourceManager,
      ...
      public:
         ...
         */
        virtual void
        parseScript(Ogre::DataStreamPtr &stream, const Ogre::String &groupName);
      ...
      protected:
         ...
         */
        virtual Ogre::Resource*
        createImpl(const Ogre::String& name, Ogre::ResourceHandle handle,
         ...
         */
        void
        ServerService_GotConnection(Eris::Connection* connection);

      };

      inline EntityMapping::EntityMappingManager&
      EmberEntityMappingManager::getManager()
      {
