...
namespace Ember
{
  namespace OgreView
  {
     ...
     */
    class AvatarCameraWarper : public ConsoleObject,
    ...
    public:
       ...
       */
      AvatarCameraWarper(MovementController& movementController,
          const Camera::MainCamera& camera, Eris::View& view,
    ...
    private:
      ...
      void
      frameProcessed(const TimeFrame& timeFrame, unsigned int eventMask);
       ...
       */
      void
      updateAvatarPosition(const Ogre::Vector3& worldPosition);
    };
