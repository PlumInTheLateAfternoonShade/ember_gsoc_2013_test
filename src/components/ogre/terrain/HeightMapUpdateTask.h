...
namespace Ember
{
  namespace OgreView
  {
    ...
    namespace Terrain
    {
       ...
       */
      class HeightMapUpdateTask : public Tasks::TemplateNamedTask<
          HeightMapUpdateTask>
      {
      public:
         ...
         */
        HeightMapUpdateTask(HeightMapBufferProvider& provider,
            HeightMap& heightMap, const SegmentStore& segments);
        virtual
        ~HeightMapUpdateTask();
