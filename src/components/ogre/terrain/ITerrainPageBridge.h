  ...
  namespace OgreView
  {
    namespace Terrain
    {
      ...
      public:
         ...
         */
        virtual void
        updateTerrain(TerrainPageGeometry& geometry) = 0;
         ...
         */
        void
        bindToTerrainPage(TerrainPage* terrainPage);
      ...
      inline void
      ITerrainPageBridge::bindToTerrainPage(TerrainPage* terrainPage)
      {
        mTerrainPage = terrainPage;
      }

      inline void
      ITerrainPageBridge::unbindFromTerrainPage()
      {
        mTerrainPage = 0;
      }

      inline TerrainPage*
      ITerrainPageBridge::getTerrainPage() const
      {
        return mTerrainPage;
      }
