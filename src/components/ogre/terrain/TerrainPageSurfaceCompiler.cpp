...
namespace Ember
{
  namespace OgreView
  {
    namespace Terrain
    {
      ...
      TerrainPageSurfaceCompiler::createCompilationInstance(
          ...
          const TerrainPageShadow* terrainPageShadow) const
      {
        return new TerrainPageSurfaceCompilationInstance(
            mCompilerTechniqueProvider.createTechnique(geometry,
                terrainPageSurfaces, terrainPageShadow));
      ...
      bool
      TerrainPageSurfaceCompilationInstance::prepare()
      {
        return mTechnique->prepareMaterial();
      }

      bool
      TerrainPageSurfaceCompilationInstance::compile(Ogre::MaterialPtr material)
      {
