  ...
  namespace OgreView
  {
    ...
    namespace Terrain
    {
      ...
      public:
        ...
        void
        reposition(const Ogre::Vector2& pos);
        /**
        ...
        void
        setRenderTarget(Ogre::RenderTarget* renderTarget);
      ...
      public:
         ...
         */
        void
        setResolution(float metersPerPixel);
