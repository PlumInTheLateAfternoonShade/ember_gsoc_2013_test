...
namespace Ember
{
  namespace OgreView
  {
    ...
    namespace Terrain
    {
      ...
      HeightMapBuffer::HeightMapBuffer(HeightMapBufferProvider& provider,
          BufferType* buffer) :
      ...
      HeightMapBuffer::BufferType*
      HeightMapBuffer::getBuffer()
      {
        return mBuffer;
      }

      unsigned int
      HeightMapBuffer::getResolution() const
      {
