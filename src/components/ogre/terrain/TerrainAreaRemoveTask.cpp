  ...
  namespace OgreView
  {
    ...
    namespace Terrain
    {
      ...
      TerrainAreaRemoveTask::TerrainAreaRemoveTask(Mercator::Terrain& terrain,
          ...
          const TerrainShader* shader, AreaMap& areas,
          const std::string& entityId) :
          TerrainAreaTaskBase(terrain, area, markForUpdateSlot), mShader(
              shader), mAreas(areas), mEntityId(entityId)
      {
      ...
      void
      TerrainAreaRemoveTask::executeTaskInBackgroundThread(
      ...
      void
      TerrainAreaRemoveTask::executeTaskInMainThread()
      {
        if (mShader)
          {
