  ...
  namespace OgreView
  {
    namespace Terrain
    {
      ...
      public:
         ...
         */
        virtual Ogre::Real
        getHeightAt(const Ogre::Real x, const Ogre::Real z) = 0;
         ...
         */
        virtual void
        setWorldPagesDimensions(int numberOfPagesWidth, int numberOfPagesHeight,
            int widthOffsetInPages, int heightOffsetInPages) = 0;
         ...
         */
        virtual void
        setCamera(Ogre::Camera* camera) = 0;
         ...
         */
        virtual void
        setResourceGroupName(const std::string& groupName) = 0;
         ...
         */
        virtual void
        loadOptions(const std::string& filePath) = 0;
         ...
         */
        virtual void
        resize(Ogre::AxisAlignedBox newSize, int levels) = 0;
         ...
         */
        virtual void
        setOption(const std::string& strKey, const void* pValue) = 0;
         ...
         */
        virtual void
        getOption(const std::string& strKey, void* pDestValue) = 0;
         ...
         */
        virtual void
        setUninitializedHeight(float height) = 0;
         ...
         */
        virtual void
        reloadPage(unsigned int x, unsigned int z) = 0;
         ...
         */
        virtual void
        destroyObserver(ITerrainObserver* observer) = 0;
