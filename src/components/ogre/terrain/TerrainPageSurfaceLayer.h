...
namespace Ember
{
  namespace OgreView
  {
    namespace Terrain
    {
      ...
      {
      public:
        TerrainPageSurfaceLayer(TerrainPageSurface& terrainPageSurface,
        ...
        const std::string&
        getDiffuseTextureName() const;
        void
        setDiffuseTextureName(const std::string& textureName);
        const std::string&
        getSpecularTextureName() const;
        void
        setSpecularTextureName(const std::string& textureName);
        const std::string&
        getNormalTextureName() const;
        void
        setNormalTextureName(const std::string& textureName);
         ...
         */
        bool
        intersects(const TerrainPageGeometry& geometry) const;

        int
        getSurfaceIndex() const;
        Mercator::Surface*
        getSurfaceForSegment(const Mercator::Segment* segment) const;
        ...
        void
        populate(const TerrainPageGeometry& geometry);

        void
        fillImage(const TerrainPageGeometry& geometry, Image& image,
