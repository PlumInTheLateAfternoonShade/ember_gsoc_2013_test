  ...
  namespace OgreView
  {
    namespace Terrain
    {
      ...
      public:
         ...
         */
        TerrainPage(const Domain::TerrainIndex& index, int pageSize,
         ...
         */
        int
        getNumberOfSegmentsPerAxis() const;
        ...
        addShader(const TerrainShader* shader);
         ...
         */
        TerrainPageSurfaceLayer*
        updateShaderTexture(const TerrainShader* shader,
            TerrainPageGeometry& geometry, bool repopulate = true);
         ...
         */
        void
        updateAllShaderTextures(TerrainPageGeometry& geometry, bool repopulate =
            true);
         ...
         */
        bool
        getNormal(const Domain::TerrainPosition& localPosition,
      ...
      private:
         ...
         */
        unsigned int
        getAlphaMapScale() const;
      };

      inline int
      TerrainPage::getAlphaTextureSize() const
      {
