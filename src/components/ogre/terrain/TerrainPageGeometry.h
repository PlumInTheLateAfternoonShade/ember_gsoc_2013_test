  ...
  namespace OgreView
  {
    namespace Terrain
    {
      ...
      public:
         ...
         */
        TerrainPageGeometry(TerrainPage& page, SegmentManager& segmentManager,
            float defaultHeight);
         ...
         */
        void
        updateOgreHeightData(float* heightData);
         ...
         */
        Mercator::Segment*
        getSegmentAtLocalPosition(const Domain::TerrainPosition& pos) const;
         ...
         */
        Mercator::Segment*
        getSegmentAtLocalPosition(const Domain::TerrainPosition& pos,
            Domain::TerrainPosition& localPositionInSegment) const;

        /**
         * @brief Gets the collection of segments which make up this geometry.
         */
        const SegmentVector
        getValidSegments() const;
      ...
      private:
         ...
         */
        void
        blitSegmentToOgre(float* ogreHeightData, Mercator::Segment& segment,
