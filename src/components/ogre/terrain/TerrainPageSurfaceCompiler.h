  ...
  namespace OgreView
  {
    namespace Terrain
    {
      ...
      public:
         ...
         */
        virtual
        ~TerrainPageSurfaceCompilerTechnique()
        {
        }
         ...
         */
        virtual bool
        compileMaterial(Ogre::MaterialPtr material) = 0;
      };
      ...
      public:
         ...
         */
        bool
        compile(Ogre::MaterialPtr material);
      ...
      public:
         ...
         */
        TerrainPageSurfaceCompilationInstance*
        createCompilationInstance(const TerrainPageGeometryPtr& geometry,
      ...
      private:
         ...
         */
        TerrainPageSurfaceCompilerTechnique*
        selectTechnique(const TerrainPageGeometryPtr& geometry,
            const SurfaceLayerStore& terrainPageSurfaces,
            const TerrainPageShadow* terrainPageShadow) const;
