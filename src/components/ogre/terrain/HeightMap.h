  ...
  namespace OgreView
  {
    ...
    namespace Terrain
    {
      ...
      public:
         ...
         */
        void
        insert(int xIndex, int yIndex, IHeightMapSegment* segment);
         ...
         */
        bool
        getHeightAndNormal(float x, float y, float& height,
      ...
      private:
        ...
        getSegment(int xIndex, int yIndex) const;
      };
