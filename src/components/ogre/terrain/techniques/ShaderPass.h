    ...
    namespace Terrain
    {
      ...
      namespace Techniques
      {
        ...
        public:
          ...
          ShaderPass(Ogre::SceneManager& sceneManager, int coveragePixelWidth,
              const WFMath::Point<2>& position);
          virtual
          ~ShaderPass();

          virtual void
          addLayer(const TerrainPageGeometry& geometry,
              const TerrainPageSurfaceLayer* layer);
          virtual void
          setBaseLayer(const TerrainPageSurfaceLayer* layer);
          void
          addShadowLayer(const TerrainPageShadow* terrainPageShadow);

          virtual bool
          hasRoomForLayer(const TerrainPageSurfaceLayer* layer);
           ...
           */
          virtual bool
          finalize(Ogre::Pass& pass, bool useShadows = true,
        ...
        protected:
          ...
          unsigned int
          getCoveragePixelWidth() const;
          Ogre::TexturePtr
          getCombinedCoverageTexture(size_t passIndex, size_t batchIndex) const;
