  ...
  namespace OgreView
  {
    ...
    namespace Terrain
    {
      ...
      namespace Techniques
      {
        ...
        {
        public:
          ShaderNormalMappedPassCoverageBatch(ShaderPass& shaderPass,
              unsigned int coverageImageWidth);
          virtual
          ~ShaderNormalMappedPassCoverageBatch()
          {
          }

          virtual void
          finalize(Ogre::Pass& pass, Ogre::TexturePtr texture);
