...
namespace Ember
{
  namespace OgreView
  {
    ...
    namespace Terrain
    {
       ...
       */
      class TerrainMaterialCompilationTask : public Tasks::TemplateNamedTask<
          TerrainMaterialCompilationTask>
      {
      public:
        ...
        virtual void
        executeTaskInBackgroundThread(Tasks::TaskExecutionContext& context);

        virtual void
        executeTaskInMainThread();
      private:
         ...
         */
        typedef std::vector<
            std::pair<TerrainPageSurfaceCompilationInstance*, TerrainPage*>> CompilationInstanceStore;
