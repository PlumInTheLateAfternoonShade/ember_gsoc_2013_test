  ...
  namespace OgreView
  {
    ...
    namespace Terrain
    {
      ...
      protected:
         ...
         */
        void
        attributeChanged(const Atlas::Message::Element& attributeValue);
      ...
      inline Mercator::Area*
      TerrainArea::getArea() const
      {
        return mArea;
      }
      inline void
      TerrainArea::setArea(Mercator::Area* area)
      {
        mArea = area;
      }
