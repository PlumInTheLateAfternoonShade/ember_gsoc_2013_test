  ...
  namespace OgreView
  {
    ...
    namespace Terrain
    {
      ...
      namespace Foliage
      {
        ...
        public:
          virtual void
          scale(WFMath::MTRand& rnd, const WFMath::Point<2>& pos,
              Ogre::Vector2& scale) = 0;
        };
        ...
        public:
          ...
          PlantPopulator(unsigned int layerIndex, IScaler* scaler,
              unsigned int plantIndex);
          virtual
          ~PlantPopulator();

          virtual void
          populate(PlantAreaQueryResult& result, SegmentRefPtr segmentRef) = 0;
