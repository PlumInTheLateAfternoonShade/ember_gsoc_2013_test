...
namespace Ember
{
  namespace OgreView
  {
    ...
    public:
       ...
       */
      void
      loadSection(const std::string& sectionName, bool initializeAlso = true);
       ...
       */
      const ResourceLocationsMap&
      getResourceLocations() const;
    ...
    protected:
      ...
      bool
      addUserMedia(const std::string& path, const std::string& type,
          const std::string& section, bool recursive);
      bool
      addSharedMedia(const std::string& path, const std::string& type,
          const std::string& section, bool recursive);

      bool
      isExistingDir(const std::string& path) const;
       ...
       */
      bool
      addResourceDirectory(const std::string& path, const std::string& type,
          const std::string& section, bool recursive, bool reportFailure,
