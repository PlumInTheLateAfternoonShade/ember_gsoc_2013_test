...
namespace Ember
{
  ...
  namespace OgreView
  {
    ...
    protected:
      ...
      void
      frameCompleted(const TimeFrame& timeFrame, unsigned int frameActionMask);
    ...
    public:
       ...
       */
      void
      changeGraphicsLevel(float changeInFpsRequired);
    ...
    protected:
       ...
       */
      void
      Config_DefaultFps(const std::string& section, const std::string& key,
       ...
       */
      void
      Config_Enabled(const std::string& section, const std::string& key,
          varconf::Variable& variable);
