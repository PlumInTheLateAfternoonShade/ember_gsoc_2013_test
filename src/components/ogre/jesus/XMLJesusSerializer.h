...
namespace Ember
{
  namespace OgreView
  {
    ...
    public:
       ...
       */
      bool
      loadBlockSpec(const std::string & filename);
       ...
       */
      bool
      loadBuildingBlockSpecDefinition(const std::string& filename);
       ...
       */
      bool
      loadModelBlockMapping(const std::string& filename);
       ...
       */
      Carpenter::BluePrint*
      loadBlueprint(const std::string& filename);
       ...
       */
      void
      saveBlueprintToFile(Carpenter::BluePrint* blueprint,
    ...
    private:
      ...
      Carpenter::AttachPoint*
      readAttachPoint(TiXmlElement* elem);
      void
      readAttachPairs(Carpenter::BlockSpec *blockSpec,
      ...
      template<typename T>
        void
        fillFromElement(TiXmlElement*, T&);
