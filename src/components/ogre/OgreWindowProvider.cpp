...
namespace Ember
{
  ...
  namespace OgreView
  {
    ...
    std::string
    OgreWindowProvider::getWindowHandle()
    {
    ...
    bool
    OgreWindowProvider::isWindowVisible()
    {
      return mWindow.isVisible();
    }

    void
    OgreWindowProvider::processInput()
    {
      Ogre::WindowEventUtilities::messagePump();
    }

    void
    OgreWindowProvider::getWindowSize(unsigned int& width, unsigned int& height)
    {
      unsigned int depth;
      int left, top;
    ...
    void
    OgreWindowProvider::windowResized(Ogre::RenderWindow* rw)
    {
    ...
    bool
    OgreWindowProvider::windowClosing(Ogre::RenderWindow* rw)
    {
    ...
    void
    OgreWindowProvider::windowClosed(Ogre::RenderWindow* rw)
    {
    ...
    void
    OgreWindowProvider::windowFocusChange(Ogre::RenderWindow* rw)
    {
