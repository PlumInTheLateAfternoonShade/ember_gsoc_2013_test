  ...
  namespace OgreView
  {
    ...
    namespace Lod
    {
      ...
      public:
         ...
         * @brief Constructor.
         */
        LodLevelManager(GraphicalChangeAdapter& graphicalChangeAdapter,
         ...
         */
        bool
        setLodBiasAll(Ogre::Real factor);
      ...
      protected:
         ...
         */
        bool
        stepDownLodBias(float step);

        /**
         * @brief Connected to the config service to listen for lod bias settings.
         */
        void
        Config_LodBias(const std::string& section, const std::string& key,
