...
namespace Ember
{
  namespace OgreView
  {
    ...
    void
    OgreLogObserver::messageLogged(const String& message, LogMessageLevel lml,
      ...
      if (!skipThisMessage)
        {
          ...
          if (Ogre::StringUtil::startsWith(message, "Can't assign material",
              false))
            {
          ...
          case Ogre::LML_TRIVIAL:
            Log::slog("Ogre", Log::VERBOSE) << ogre << message
                << Log::END_MESSAGE;
            break;
          ...
          case Ogre::LML_CRITICAL:
            Log::slog("Ogre", Log::FAILURE) << ogre << message
                << Log::END_MESSAGE;
            break;
