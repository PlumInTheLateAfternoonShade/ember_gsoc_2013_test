...
namespace OgreOpcode
{
  ...
  {
  public:
    CharacterController(Ogre::SceneNode* CharacterBaseNode,
        Ogre::Real CharacterRadius, Ogre::Real CharacterHeight,
        Ogre::Vector3 Gravity = Ogre::Vector3(0, -9.8, 0),
        Ogre::Degree SlopeThreshold = Ogre::Degree(60),
        Ogre::Real UnitsPerMeter = 1.0);
    ~CharacterController();
    ...
    void
    move(Ogre::Vector3 velocity);

    void
    setHeight(Ogre::Real Height);
    void
    setRadius(Ogre::Real Radius);
    void
    setGravity(const Ogre::Vector3& Gravity);
    void
    setSlopeThreshold(const Ogre::Degree& SlopeThreshold);
  ...
  private:
     ...
     */
    Ogre::Vector3
    _collideAndSlide(const Ogre::Vector3& vel);
    Ogre::Vector3
    _collideWithWorld(int recursionDepth, const Ogre::Vector3& pos,
        const Ogre::Vector3& vel, CollisionPacket& colData, bool gravityStep,
        const Ogre::Degree& slopeSlideThresold);
    void
    _doOgreOpcodeCollision(CollisionPacket& colData, float sweepOffset);
  };
}
