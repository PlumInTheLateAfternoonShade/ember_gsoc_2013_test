...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
inline_ BOOL
PlanesCollider::PlanesAABBOverlap(const IceMaths::Point& center_,
    const IceMaths::Point& extents_, udword& out_clip_mask, udword in_clip_mask)
{
      ...
      if (in_clip_mask & Mask)				// if clip plane is active, process it..
        {
          ...
          float MP = center.x * p->n.x + center.y * p->n.y + center.z * p->n.z
              + p->d;
