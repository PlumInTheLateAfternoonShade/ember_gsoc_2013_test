...
public:
  ...
  Reset()
  {
    IceCore::Container::Reset();
  }

  inline_
  void
  AddFace(const CollisionFace& face)
  {
...
public:
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  bool
  Collide(const IceMaths::Ray& world_ray, const Model& model,
      const IceMaths::Matrix4x4* world = null, udword* cache = null);
  //
  bool
  Collide(const IceMaths::Ray& world_ray, const AABBTree* tree,
      IceCore::Container& box_indices);
  // Settings
  ...
  inline_
  void
  SetMaxDist(float max_dist = MAX_FLOAT)
  {
    mMaxDist = max_dist;
  }
  ...
  inline_
  void
  SetDestination(CollisionFaces* cf)
  {
    mStabbedFaces = cf;
  }
#endif
...
protected:
  ...
  // Internal methods
  void
  _SegmentStab(const AABBCollisionNode* node);
  void
  _SegmentStab(const AABBNoLeafNode* node);
  void
  _SegmentStab(const AABBQuantizedNode* node);
  void
  _SegmentStab(const AABBQuantizedNoLeafNode* node);
  void
  _SegmentStab(const AABBTreeNode* node, IceCore::Container& box_indices);
  void
  _RayStab(const AABBCollisionNode* node);
  void
  _RayStab(const AABBNoLeafNode* node);
  void
  _RayStab(const AABBQuantizedNode* node);
  void
  _RayStab(const AABBQuantizedNoLeafNode* node);
  void
  _RayStab(const AABBTreeNode* node, IceCore::Container& box_indices);
  // Overlap tests
  inline_
  BOOL
  RayAABBOverlap(const IceMaths::Point& center, const IceMaths::Point& extents);inline_
  BOOL
  SegmentAABBOverlap(const IceMaths::Point& center,
      const IceMaths::Point& extents);inline_
  BOOL
  RayTriOverlap(const IceMaths::Point& vert0, const IceMaths::Point& vert1,
      const IceMaths::Point& vert2);
  // Init methods
  BOOL
  InitQuery(const IceMaths::Ray& world_ray, const IceMaths::Matrix4x4* world =
      null, udword* face_id = null);
};
