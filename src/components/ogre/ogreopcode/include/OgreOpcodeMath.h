...
namespace OgreOpcode
{
  namespace Details
  {
    ...
    inline Ogre::Real
    operator |(const Ogre::Vector3& u, const Ogre::Vector3& v)
    {
    ...
    public:
      ...
      ;
      line3(const Ogre::Vector3& v0, const Ogre::Vector3& v1) :
          b(v0), m(v1 - v0)
      {
      }
      ;
      ...
      void
      set(const Ogre::Vector3& v0, const Ogre::Vector3& v1)
      {
        b = v0;
        m = v1 - v0;
      }
    ...
    public:
      ...
      ;
      triangle(const Ogre::Vector3& v0, const Ogre::Vector3& v1,
      ...
      bool
      isPointInsideFast(Ogre::Vector3 &p)
      {
        ...
        return ((((unsigned int&) z)
            & ~(((unsigned int&) x) | ((unsigned int&) y))) & 0x80000000) != 0;
      }
      ...
      //
      bool
      intersect(const line3& line, Ogre::Real& ipos)
      {
      ...
      //
      bool
      intersect_both_sides(const line3& line, Ogre::Real& ipos)
      {
...
#define n_min(a,b)      (((a) < (b)) ? (a) : (b))
    ...
    public:
      ...
      enum
      {
        OUTSIDE = 0, ISEQUAL = (1 << 0), ISCONTAINED = (1 << 1), CONTAINS = (1
            << 2), CLIPS = (1 << 3),
      };
      ...
      ;
      bbox3(const Ogre::Vector3& _vmin, const Ogre::Vector3& _vmax) :
          vmin(_vmin), vmax(_vmax)
      {
      }
      ;
      bbox3(const bbox3& bb) :
          vmin(bb.vmin), vmax(bb.vmax)
      {
      }
      ;
      ...
      bbox3(Ogre::Vector3 *varray, int num)
      {
        ...
        for (i = 0; i < num; i++)
          {
            if (varray[i].x < vmin.x)
              vmin.x = varray[i].x;
            else if (varray[i].x > vmax.x)
              vmax.x = varray[i].x;
            if (varray[i].y < vmin.y)
              vmin.y = varray[i].y;
            else if (varray[i].y > vmax.y)
              vmax.y = varray[i].y;
            if (varray[i].z < vmin.z)
              vmin.z = varray[i].z;
            else if (varray[i].z > vmax.z)
              vmax.z = varray[i].z;
          }
      }
      ;
      ...
      void
      getCenter(Ogre::Vector3& v) const
      {
        v = (vmin + vmax) * 0.5;
      }
      ...
      void
      getExtents(Ogre::Vector3& v) const
      {
        v = (vmax - vmin) * 0.5;
      }
      ...
      //--- setting elements ------------------------------------------
      void
      set(const Ogre::Vector3& _vmin, const Ogre::Vector3& _vmax)
      {
        vmin = _vmin;
        vmax = _vmax;
      }
      ;
      void
      set(Ogre::Vector3 *varray, int num)
      {
        vmin = varray[0];
        vmax = varray[0];
        int i;
      ...
      ;
      void
      grow(Ogre::Vector3 *varray, int num)
      {
        int i;
        for (i = 0; i < num; i++)
          {
      ...
      // on const x,y,z
      bool
      isect_const_x(const float x, const line3& l, Ogre::Vector3& out) const
      {
        if (l.m.x != 0.0f)
          {
      ...
      bool
      isect_const_y(const float y, const line3& l, Ogre::Vector3& out) const
      {
        if (l.m.y != 0.0f)
          {
      ...
      bool
      isect_const_z(const float z, const line3& l, Ogre::Vector3& out) const
      {
        if (l.m.z != 0.0f)
          {
      ...
      bool
      pip_const_x(const Ogre::Vector3& p) const
      {
      ...
      bool
      pip_const_y(const Ogre::Vector3& p) const
      {
      ...
      bool
      pip_const_z(const Ogre::Vector3& p) const
      {
      ...
      bool
      intersect(const line3& line) const
      {
       ...
       */
      bool
      intersect(const line3& line, Ogre::Vector3& ipos) const
      {
      ...
      int
      line_test(float v0, float v1, float w0, float w1)
      {
    ...
    public:
      ...
      ;
      sphere(const Ogre::Vector3& _p, Ogre::Real _r) :
          p(_p), r(_r)
      {
      }
      ;
      ...
      void
      set(const Ogre::Vector3& _p, Ogre::Real _r)
      {
        p = _p;
        r = _r;
      }
      ;
      void
      set(Ogre::Real _x, Ogre::Real _y, Ogre::Real _z, Ogre::Real _r)
      {
        p = Ogre::Vector3(_x, _y, _z);
        r = _r;
      }
      ...
      bool
      intersects(const sphere& s) const
      {
        Ogre::Vector3 d(s.p - p);
        Ogre::Real rsum = s.r + r;
        if (d.squaredLength() <= (rsum * rsum))
          return true;
        else
          return false;
      }
      ...
      bool
      intersect_sweep(const Ogre::Vector3& va, // in: distance travelled by 'this'
    ...
    public:
      ...
      Segment3(const Ogre::Vector3& s, const Ogre::Vector3& e)
      {
        _start = s;
        _end = e;
      }
      ...
      inline void
      set(const Ogre::Vector3& s, const Ogre::Vector3& e)
      {
        _start = s;
        _end = e;
      }
    ...
    public:
       ...
       */
      static bool
      triangleTriangle(const Ogre::Vector3 tri1[3],
       ...
       */
      static bool
      triangleTriangle(const Ogre::Vector3 tri1[3], const Ogre::Vector3 tri2[3],
          Segment3& isectline, bool& coplanar);

    };

    Ogre::String
    decimalToBinary(unsigned int i);

    bool
    powerOf2(unsigned int i);
  }
}
