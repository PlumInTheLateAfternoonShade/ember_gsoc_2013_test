...
namespace OgreOpcode
{
  namespace Details
  {
    ...
    public:
      ...
      Ray3() :
          origin(), direction(-Ogre::Vector3::UNIT_Z)
      {
      }
      ...
      /// Full constructor
      Ray3(const Ogre::Vector3& ori, const Ogre::Vector3& dir) :
      ...
      /// Full constructor
      Ray3(Ogre::Real ox, Ogre::Real oy, Ogre::Real oz, Ogre::Real dx,
          Ogre::Real dy, Ogre::Real dz) :
      ...
      /// Setups this ray
      void
      set(Ogre::Real ox, Ogre::Real oy, Ogre::Real oz, Ogre::Real dx,
          Ogre::Real dy, Ogre::Real dz)
      {
        origin.x = ox;
        origin.y = oy;
      ...
      /// Setups this ray
      void
      set(const Ogre::Vector3& ori, const Ogre::Vector3& dir)
      {
        origin = ori;
        direction = dir;
        direction.normalise();
      ...
      void
      setOrigin(Ogre::Real x, Ogre::Real y, Ogre::Real z)
      {
        origin.x = x;
        origin.y = y;
        origin.z = z;
      ...
      /// Sets the origin of this ray
      void
      setOrigin(const Ogre::Vector3& v)
      {
        origin = v;
      }
       ...
       */
      void
      setDirection(Ogre::Real x, Ogre::Real y, Ogre::Real z, bool normalize =
          true)
      {
        direction.x = x;
        direction.y = y;
       ...
       */
      void
      setDirection(const Ogre::Vector3& v, bool normalize = true)
      {
        direction = v;
        if (normalize)
          direction.normalise();
       ...
       */
      Ogre::Vector3
      getPointAt(Ogre::Real delta) const
      {
...
// Distance methods				
       ...
       */
      Ogre::Real
      squaredDistance(const Ogre::Vector3& point) const;

      /** Computes the distance from this ray to a point
       */
      Ogre::Real
      distance(const Ogre::Vector3& point) const;

      /** Computes the <em>squared</em> distance from this ray to a line
       */
      Ogre::Real
      squaredDistance(const Line& line) const;

      /** Computes the distance from this ray to a line
       */
      Ogre::Real
      distance(const Line& line) const;
...
// Picking methods
       ...
       */
      bool
      pick(const Aabb& aabb, Ogre::Real& dist) const;
       ...
       */
      bool
      pick(const OrientedBox& obb, Ogre::Real& dist) const;
       ...
       */
      bool
      pick(const Ogre::Sphere& sphere, Ogre::Real& dist) const;
