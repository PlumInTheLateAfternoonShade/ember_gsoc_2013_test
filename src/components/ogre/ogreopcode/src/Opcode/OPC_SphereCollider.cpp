...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool
SphereCollider::Collide(SphereCache& cache, const IceMaths::Sphere& sphere,
    const Model& model, const IceMaths::Matrix4x4* worlds,
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL
SphereCollider::InitQuery(SphereCache& cache, const IceMaths::Sphere& sphere,
    const IceMaths::Matrix4x4* worlds, const IceMaths::Matrix4x4* worldm)
{
      ...
      if (FirstContactEnabled())
      ...
      else
        {
          ...
          if (IsCacheValid(cache)
              && cache.Center.SquareDistance(mCenter) < r * r)
            {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
inline_ BOOL
SphereCollider::SphereContainsBox(const IceMaths::Point& bc_,
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
SphereCollider::_Collide(const AABBCollisionNode* node)
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
SphereCollider::_CollideNoPrimitiveTest(const AABBCollisionNode* node)
{
  // Perform Sphere-AABB overlap test
  if (!SphereAABBOverlap(node->mAABB.mCenter, node->mAABB.mExtents))
    return;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
SphereCollider::_Collide(const AABBQuantizedNode* node)
{
  // Dequantize box
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
SphereCollider::_CollideNoPrimitiveTest(const AABBQuantizedNode* node)
{
  // Dequantize box
  const QuantizedAABB& Box = node->mAABB;
  const IceMaths::Point Center(float(Box.mCenter[0]) * mCenterCoeff.x,
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
SphereCollider::_Collide(const AABBNoLeafNode* node)
{
  // Perform Sphere-AABB overlap test
  if (!SphereAABBOverlap(node->mAABB.mCenter, node->mAABB.mExtents))
    return;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
SphereCollider::_CollideNoPrimitiveTest(const AABBNoLeafNode* node)
{
  // Perform Sphere-AABB overlap test
  if (!SphereAABBOverlap(node->mAABB.mCenter, node->mAABB.mExtents))
    return;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
SphereCollider::_Collide(const AABBQuantizedNoLeafNode* node)
{
  // Dequantize box
  const QuantizedAABB& Box = node->mAABB;
  const IceMaths::Point Center(float(Box.mCenter[0]) * mCenterCoeff.x,
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
SphereCollider::_CollideNoPrimitiveTest(const AABBQuantizedNoLeafNode* node)
{
  // Dequantize box
  const QuantizedAABB& Box = node->mAABB;
  const IceMaths::Point Center(float(Box.mCenter[0]) * mCenterCoeff.x,
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
SphereCollider::_Collide(const AABBTreeNode* node)
{
  // Perform Sphere-AABB overlap test
...
bool
HybridSphereCollider::Collide(SphereCache& cache,
    const IceMaths::Sphere& sphere, const HybridModel& model,
    const IceMaths::Matrix4x4* worlds, const IceMaths::Matrix4x4* worldm)
{
