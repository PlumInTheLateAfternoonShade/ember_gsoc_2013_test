...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
IceMaths::InvertPRMatrix(Matrix4x4& dest, const Matrix4x4& src)
{
  dest.m[0][0] = src.m[0][0];
  dest.m[1][0] = src.m[0][1];
  dest.m[2][0] = src.m[0][2];
  dest.m[3][0] = -(src.m[3][0] * src.m[0][0] + src.m[3][1] * src.m[0][1]
      + src.m[3][2] * src.m[0][2]);

  dest.m[0][1] = src.m[1][0];
  dest.m[1][1] = src.m[1][1];
  dest.m[2][1] = src.m[1][2];
  dest.m[3][1] = -(src.m[3][0] * src.m[1][0] + src.m[3][1] * src.m[1][1]
      + src.m[3][2] * src.m[1][2]);

  dest.m[0][2] = src.m[2][0];
  dest.m[1][2] = src.m[2][1];
  dest.m[2][2] = src.m[2][2];
  dest.m[3][2] = -(src.m[3][0] * src.m[2][0] + src.m[3][1] * src.m[2][1]
      + src.m[3][2] * src.m[2][2]);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
IceMaths::InvertPRSMatrix(Matrix4x4& dest, const Matrix4x4& src)
{
  // first, inverts the rotation part.
  float invS2 = 1.0f
      / (src.m[0][0] * src.m[0][0] + src.m[0][1] * src.m[0][1]
          + src.m[0][2] * src.m[0][2]);
  ...
  invS2 = 1.0f
      / (src.m[1][0] * src.m[1][0] + src.m[1][1] * src.m[1][1]
          + src.m[1][2] * src.m[1][2]);
  ...
  invS2 = 1.0f
      / (src.m[2][0] * src.m[2][0] + src.m[2][1] * src.m[2][1]
          + src.m[2][2] * src.m[2][2]);
  ...
  dest.m[3][0] = -(dest[0][0] * src.m[3][0] + dest[1][0] * src.m[3][1]
      + dest[2][0] * src.m[3][2]);
  dest.m[3][1] = -(dest[0][1] * src.m[3][0] + dest[1][1] * src.m[3][1]
      + dest[2][1] * src.m[3][2]);
  dest.m[3][2] = -(dest[0][2] * src.m[3][0] + dest[1][2] * src.m[3][1]
      + dest[2][2] * src.m[3][2]);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
IceMaths::NormalizePRSMatrix(Matrix4x4& dest, Point& scale,
    const Matrix4x4& src)
{
  Point row;
  dest = src;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float
Matrix4x4::CoFactor(udword row, udword col) const
{
