...
namespace OgreOpcode
{
  ...
  ///////////////////////////////////////////////////////////////////////////////
  void
  EntityCollisionShape::countIndicesAndVertices(Entity * entity,
...
// 		Mesh * mesh = entity->getMesh().getPointer();
  ...
  //////////////////////////////////////////////////////////////////////////
  void
  EntityCollisionShape::convertMeshData(Entity * entity, float * vertexBuf,
      size_t vertex_count, size_t * faceBuf, size_t index_count)
  {
    //---------------------------------------------------------------------
    // CONVERT MESH DATA
    //---------------------------------------------------------------------
// 		MeshPtr mesh = entity->getMesh();
  ...
  bool
  EntityCollisionShape::load(Entity* ent)
  {
    assert(ent);
  ...
  EntityCollisionShape::rebuild()
  {
    ...
    if (index_count > 0 && vertex_count > 0)
      {
        convertMeshData(mEntity, mVertexBuf, vertex_count, mFaceBuf,
            index_count);
        ...
        opcMeshAccess.SetPointers((IceMaths::IndexedTriangle*) mFaceBuf,
            (IceMaths::Point*) mVertexBuf);
  ...
  /// @return bool <TODO: insert return value description here>
  bool
  EntityCollisionShape::_refitToCachedData()
  {
    assert(mEntity && mVertexBuf);
  ...
  /// @return bool <TODO: insert return value description here>
  bool
  EntityCollisionShape::_rebuildFromCachedData()
  {
  ...
  /// <TODO: insert function description here>
  void
  EntityCollisionShape::createDummyNode()
  {
    if (!mDummyCreated)
      {
        mDummyNode =
            CollisionManager::getSingletonPtr()->getSceneManager()->getRootSceneNode()->createChildSceneNode(
                getName());
