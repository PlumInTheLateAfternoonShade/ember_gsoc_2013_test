...
{
  CharacterController::CharacterController(Ogre::SceneNode* CharacterBaseNode,
      Ogre::Real CharacterRadius, Ogre::Real CharacterHeight,
      Ogre::Vector3 Gravity, Ogre::Degree SlopeThreshold,
      Ogre::Real UnitsPerMeter) :
      mBaseNode(CharacterBaseNode), mRadius(CharacterRadius), mHeight(
          CharacterHeight), mGravity(Gravity), mSlopeThreshold(SlopeThreshold), mUnitsPerMeter(
          UnitsPerMeter), mContactName("")
  {
  ...
  Ogre::Vector3
  CharacterController::_collideAndSlide(const Ogre::Vector3& vel)
  {
    ...
    Ogre::Vector3 finalPosition = _collideWithWorld(0, eSpacePosition,
        eSpaceVelocity, colData, false, Ogre::Degree(0));
    ...
    if (mGravity != Ogre::Vector3::ZERO)
      {
        ...
        finalPosition = _collideWithWorld(0, eSpacePosition, eSpaceVelocity,
            colData, true, mSlopeThreshold);
      }
  ...
  Ogre::SceneNode*
  CharacterController::getBaseNode()
  {
    return mBaseNode;
  }

  Ogre::Real
  CharacterController::getHeight()
  {
    return mHeight;
  }

  Ogre::Real
  CharacterController::getRadius()
  {
    return mRadius;
  }

  Ogre::Vector3
  CharacterController::getGravity()
  {
    return mGravity;
  }

  Ogre::Degree
  CharacterController::getSlopeThreshold()
  {
    return mSlopeThreshold;
  }

  void
  CharacterController::move(Ogre::Vector3 velocity)
  {
    mBaseNode->setPosition(_collideAndSlide(velocity));
  }

  void
  CharacterController::setHeight(Ogre::Real Height)
  {
    mHeight = Height;
  }

  void
  CharacterController::setRadius(Ogre::Real Radius)
  {
    mRadius = Radius;
  }

  void
  CharacterController::setGravity(const Ogre::Vector3& Gravity)
  {
    mGravity = Gravity;
  }

  void
  CharacterController::setSlopeThreshold(const Ogre::Degree& SlopeThreshold)
  {
