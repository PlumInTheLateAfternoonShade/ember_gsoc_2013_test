...
namespace Ember
{
  ...
  namespace OgreView
  {
     ...
     */
    class EmberOgre : public Singleton<EmberOgre>,
        public virtual sigc::trackable,
        public EmberOgreSignals
    {
    public:
      ...
      getAutomaticGraphicsLevelManager() const;
       ...
       */
      bool
      renderOneFrame(const TimeFrame& timeFrame);
       ...
       */
      bool
      setup(Input& input, MainLoopController& mainLoopController);
    ...
    protected:
      ...
      /**
       * @brief Injects the Lods generated by the worker to the meshes.
       */
      Lod::PMInjector* mPMInjector;
    ...
    EmberOgre::getRenderWindow() const
    {
      return mWindow;
    }
