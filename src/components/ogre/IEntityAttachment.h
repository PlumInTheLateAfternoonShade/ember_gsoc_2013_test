...
namespace Ember
{
  namespace OgreView
  {
    ...
    public:
      ...
      getGraphicalRepresentation() const = 0;
      ...
      attachEntity(EmberEntity& entity) = 0;
      ...
      getOffsetForContainedNode(const IEntityAttachment& attachment,
          const WFMath::Point<3>& localPosition, WFMath::Vector<3>& offset) = 0;
       ...
       */
      virtual void
      setControlDelegate(IEntityControlDelegate* controllerDelegate) = 0;
