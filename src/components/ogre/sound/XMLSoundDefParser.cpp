...
namespace Ember
{
  namespace OgreView
  {
    ...
    void
    XMLSoundDefParser::parseScript(Ogre::DataStreamPtr stream)
    {
      ...
      if (rootElem)
        {
          for (TiXmlElement* smElem = rootElem->FirstChildElement();
              smElem != 0; smElem = smElem->NextSiblingElement())
            {
              ...
              SoundGroupDefinition* newModel =
                  mManager.createSoundGroupDefinition(finalName);
    ...
    void
    XMLSoundDefParser::readBuffers(SoundGroupDefinition* grp,
        TiXmlElement* objNode)
    {
      for (TiXmlElement* smElem = objNode->FirstChildElement(); smElem != 0;
    ...
    void
    XMLSoundDefParser::readBuffer(SoundGroupDefinition* grp,
        TiXmlElement* objNode)
    {
