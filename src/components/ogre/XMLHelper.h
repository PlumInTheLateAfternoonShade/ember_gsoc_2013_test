...
namespace Ember
{
  namespace OgreView
  {
    ...
    public:
       ...
       */
      bool
      Load(TiXmlDocument& xmlDoc, Ogre::DataStreamPtr stream);
       ...
       */
      static Ogre::Vector3
      fillVector3FromElement(TiXmlElement* elem);
       ...
       */
      static void
      fillElementFromVector3(TiXmlElement& elem, Ogre::Vector3 vector);
      ...
      fillQuaternionFromElement(TiXmlElement* elem);
       ...
       */
      static void
      fillElementFromQuaternion(TiXmlElement& elem,
