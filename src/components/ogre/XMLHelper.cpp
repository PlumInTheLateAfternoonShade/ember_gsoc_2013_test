...
namespace Ember
{
  namespace OgreView
  {
    ...
    bool
    XMLHelper::Load(TiXmlDocument& xmlDoc, Ogre::DataStreamPtr stream)
    {
          ...
          if (xmlDoc.Error())
            {
              ...
              std::stringstream ss;
              ss << "Failed to load xml file '" << stream->getName()
                  << "'! Error at column: " << errorColumn << " line: "
                  << errorLine << ". Error message: " << errorDesc;
    ...
    Ogre::Vector3
    XMLHelper::fillVector3FromElement(TiXmlElement* elem)
    {
    ...
    void
    XMLHelper::fillElementFromVector3(TiXmlElement& elem, Ogre::Vector3 vector)
    {
    ...
    Ogre::Quaternion
    XMLHelper::fillQuaternionFromElement(TiXmlElement* elem)
    {
    ...
    void
    XMLHelper::fillElementFromQuaternion(TiXmlElement& elem,
