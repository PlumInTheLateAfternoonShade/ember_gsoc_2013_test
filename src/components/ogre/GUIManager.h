...
namespace Ember
{
  ...
  namespace OgreView
  {
    ...
    public:
       ...
       */
      void
      EmitEntityAction(const std::string& action, EmberEntity* entity);
       ...
       */
      void
      removeWidget(Gui::Widget* widget);
       ...
       */
      CEGUI::Window*
      createWindow(const std::string& windowType);
       ...
       */
      void
      destroyWidget(Gui::Widget* widget);
       ...
       */
      CEGUI::Texture&
      createTexture(Ogre::TexturePtr& ogreTexture);
    ...
    protected:
       ...
       */
      void
      input_SizeChanged(int width, int height);
       ...
       */
      void
      EmberOgre_CreatedAvatarEntity(EmberEntity& entity);

      void
      EmberOgre_WorldCreated(World& world);

      void
      EmberOgre_WorldDestroyed();

      void
      pressedKey(const SDL_keysym& key, Input::InputMode inputMode);
       ...
       */
      void
      view_EntityCreated(Eris::Entity* entity);
       ...
       */
      void
      entity_Talk(const Domain::EntityTalk& entityTalk, EmberEntity* entity);
