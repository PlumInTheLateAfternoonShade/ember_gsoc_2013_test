...
namespace Ember
{
  ...
  namespace OgreView
  {
    ...
    namespace Camera
    {
       ...
       */
      class MainCamera : public Ogre::FrameListener,
      ...
      public:
         ...
         */
        MainCamera(Ogre::SceneManager& sceneManager, Ogre::RenderWindow& window,
            Input& input, Ogre::Camera& camera);
        ...
        getOrientation(bool onlyHorizontal = false) const;
        ...
        void
        pickInWorld(Ogre::Real mouseX, Ogre::Real mouseY,
            const MousePickerArgs& args);

        void
        setClosestPickingDistance(Ogre::Real distance);

        Ogre::Real
        getClosestPickingDistance() const;
         ...
         */
        bool
        worldToScreen(const Ogre::Vector3& worldPos, Ogre::Vector2& screenPos);

        /**
         * Methods from Ogre::FrameListener
         */
        bool
        frameStarted(const Ogre::FrameEvent& event);
         ...
         */
        void
        enableCompositor(const std::string& compositorName, bool enable);
         ...
         */
        void
        pushWorldPickListener(IWorldPickListener* worldPickListener);

        void
        removeWorldPickListener(IWorldPickListener* worldPickListener);
         ...
         */
        ICameraMount*
        attachToMount(ICameraMount* newCameraMount);

        void
        setMovementProvider(IMovementProvider* movementProvider);
      ...
      private:
         ...
         */
        void
        Config_ClipDistances(const std::string& section, const std::string& key,
         ...
         */
        void
        Config_Compositors(const std::string& section, const std::string& key,
            varconf::Variable& variable);
         ...
         */
        void
        createRayQueries(Ogre::SceneManager& sceneManager);
         ...
         */
        void
        Input_MouseMoved(const MouseMotion& motion, Input::InputMode mode);
         ...
         */
        bool
        validateCompositionTargetPass(
            Ogre::CompositionTargetPass& compositionPass);
