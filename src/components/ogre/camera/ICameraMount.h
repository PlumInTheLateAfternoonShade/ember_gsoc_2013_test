  ...
  namespace OgreView
  {
    ...
    namespace Camera
    {
      ...
      public:
         ...
         */
        virtual Ogre::Degree
        pitch(float relativeMovement) = 0;
         ...
         */
        virtual void
        move(const WFMath::Vector<3>& movement,
            const WFMath::Quaternion& orientation, float timeslice) = 0;
         ...
         */
        virtual void
        attachToCamera(MainCamera& camera) = 0;
         ...
         */
        virtual void
        setMotionHandler(ICameraMotionHandler* handler) = 0;
