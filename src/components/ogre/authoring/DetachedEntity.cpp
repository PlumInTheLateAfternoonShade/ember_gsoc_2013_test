...
namespace Ember
{
  namespace OgreView
  {
    namespace Authoring
    {
      ...
      void
      DetachedEntity::setAttr(const std::string &p,
      ...
      void
      DetachedEntity::setFromMessage(const Atlas::Message::MapType& attrs)
      {
        beginUpdate();
      ...
      Eris::TypeService*
      DetachedEntity::getTypeService() const
      {
        return mTypeService;
      }

      void
      DetachedEntity::doInit(
          const Atlas::Objects::Entity::RootEntity& rootEntity)
      {
        init(rootEntity, true);
      }

      void
      DetachedEntity::removeFromMovementPrediction()
      {
      }

      void
      DetachedEntity::addToMovementPredition()
      {
      }

      Eris::Entity*
      DetachedEntity::getEntity(const std::string& id)
      {
        return 0;
      }
