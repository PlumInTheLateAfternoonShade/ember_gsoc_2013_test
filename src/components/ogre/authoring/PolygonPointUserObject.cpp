...
namespace Ember
{
  namespace OgreView
  {
    ...
    namespace Authoring
    {
      ...
      PolygonPoint&
      PolygonPointUserObject::getPoint()
      {
        return mPoint;
      }

      void
      PolygonPointUserObject::markAsMoved()
      {
        Ogre::Entity* entity =
            static_cast<Ogre::Entity*>(mPoint.getNode()->getAttachedObject(0));
        entity->setMaterialName("/global/authoring/polygon/point/moved");
      }

      void
      PolygonPointUserObject::resetMarking()
      {
        Ogre::Entity* entity =
            static_cast<Ogre::Entity*>(mPoint.getNode()->getAttachedObject(0));
