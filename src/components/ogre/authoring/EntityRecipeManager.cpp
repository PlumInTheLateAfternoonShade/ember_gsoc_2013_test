...
template<>
  Ember::OgreView::Authoring::EntityRecipeManager* Ember::Singleton<
      Ember::OgreView::Authoring::EntityRecipeManager>::ms_Singleton = 0;
...
namespace Ember
{
  namespace OgreView
  {
    namespace Authoring
    {
      ...
      Ogre::ResourcePtr
      EntityRecipeManager::create(const Ogre::String& name,
          ...
          const Ogre::NameValuePairList* createParams)
      {
        ...
        if (ret.isNull())
          {
            return Ogre::ResourceManager::create(name, group, isManual, loader,
                createParams);
          }
      ...
      void
      EntityRecipeManager::parseScript(Ogre::DataStreamPtr& stream,
      ...
      Ogre::Resource*
      EntityRecipeManager::createImpl(const Ogre::String& name,
