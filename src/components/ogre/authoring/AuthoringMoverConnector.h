...
namespace Ember
{
  namespace OgreView
  {
    ...
    namespace Authoring
    {
      ...
      {
      public:
        AuthoringMoverConnector(AuthoringManager& authoringManager,
            EntityMoveManager& moveManager);
        virtual
        ~AuthoringMoverConnector();
      ...
      private:
        ...
        void
        moveManager_StartMoving(EmberEntity& entity, EntityMover& mover);
        void
        moveManager_FinishedMoving();
        void
        moveManager_CancelledMoving();
      };
