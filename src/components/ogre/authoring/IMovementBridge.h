  ...
  namespace OgreView
  {
    ...
    namespace Authoring
    {
      ...
      public:
         ...
         */
        virtual void
        setPosition(const WFMath::Point<3>& position) = 0;
         ...
         */
        virtual void
        move(const WFMath::Vector<3>& directionVector) = 0;
        /**
