  ...
  namespace OgreView
  {
    namespace Authoring
    {
      ...
      public:
         ...
         * Constructor.
         */
        EntityRecipe(Ogre::ResourceManager* creator, const Ogre::String& name,
         ...
         */
        GUIAdapter*
        createGUIAdapter(const std::string& name, const std::string& type,
         ...
         */
        GUIAdapter*
        getGUIAdapter(const std::string& name);
         ...
         */
        GUIAdapterBindings*
        createGUIAdapterBindings(const std::string& name);
        ...
        createEntity(Eris::TypeService& typeService);
      ...
      public:
        ...
        explicit
        EntityRecipePtr(EntityRecipe* rep) :
