  ...
  namespace OgreView
  {
    ...
    namespace Authoring
    {
      ...
      public:
        ...
        virtual const WFMath::Quaternion&
        getOrientation() const;
        virtual const WFMath::Point<3>&
        getPosition() const;
        virtual void
        setPosition(const WFMath::Point<3>& position);
        virtual void
        move(const WFMath::Vector<3>& directionVector);
        virtual void
        setRotation(int axis, WFMath::CoordType angle);
        virtual void
        setOrientation(const WFMath::Quaternion& rotation);
        virtual void
        yaw(WFMath::CoordType angle);
      ...
      private:
        ...
        void
        input_KeyPressed(const SDL_keysym& key, Input::InputMode mode);
        void
        input_KeyReleased(const SDL_keysym& key, Input::InputMode mode);
