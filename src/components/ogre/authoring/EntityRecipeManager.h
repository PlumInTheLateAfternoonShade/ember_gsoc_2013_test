...
namespace Ember
{
  namespace OgreView
  {
    namespace Authoring
    {
       ...
       */
      class EntityRecipeManager : public Ogre::ResourceManager,
          public Singleton<EntityRecipeManager>
      {
      public:
        /**
         * Constructor
         ...
         */
        virtual Ogre::ResourcePtr
        create(const Ogre::String& name, const Ogre::String& group,
