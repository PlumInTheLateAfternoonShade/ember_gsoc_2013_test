...
namespace Ember
{
  ...
  namespace OgreView
  {
     ...
     * @see Eris::Factory
     */
    class EmberEntityFactory : public Eris::Factory,
    ...
    public:
       ...
       */
      virtual bool
      accept(const Atlas::Objects::Entity::RootEntity &ge,
          Eris::TypeInfo* type);
       ...
       */
      virtual Eris::Entity*
      instantiate(const Atlas::Objects::Entity::RootEntity &ge,
          Eris::TypeInfo* type, Eris::View* w);
       ...
       */
      void
      dumpAttributesOfEntity(const std::string& entityId) const;
    ...
    protected:
       ...
       */
      void
      deleteMapping(EntityMapping::EntityMapping* mapping);
