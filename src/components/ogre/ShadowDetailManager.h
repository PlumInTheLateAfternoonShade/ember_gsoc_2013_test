...
namespace Ember
{
  ...
  namespace OgreView
  {
    ...
    public:
       ...
       * @brief Constructor.
       */
      ShadowDetailManager(GraphicalChangeAdapter& graphicalChangeAdapter,
       ...
       */
      bool
      setShadowFarDistance(float distance);
       ...
       */
      bool
      setShadowCameraLodBias(float factor);
    ...
    protected:
       ...
       */
      bool
      stepUpShadowDistance(float step);
       ...
       */
      bool
      stepDownShadowDistance(float step);
       ...
       */
      bool
      stepUpShadowCameraLodBias(float step);
       ...
       */
      bool
      stepDownShadowCameraLodBias(float step);

      /**
       * @brief Connected to the config service to listen for shadow lod bias settings.
       */
      void
      Config_ShadowLodBias(const std::string& section, const std::string& key,
