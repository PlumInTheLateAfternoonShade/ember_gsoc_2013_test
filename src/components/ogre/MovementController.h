...
namespace Ember
{
  namespace OgreView
  {
    ...
    protected:
      ...
      void
      input_MouseButtonPressed(Input::MouseButton button,
          Input::InputMode mode);
      void
      input_MouseButtonReleased(Input::MouseButton button,
          Input::InputMode mode);
     ...
     */
    class MovementController : public Ogre::FrameListener,
...
//	const ConsoleCommandWrapper MoveCameraTo;
       ...
       */
      void
      moveToPoint(const Ogre::Vector3& point);
       ...
       */
      void
      teleportTo(const Ogre::Vector3& point, EmberEntity* locationEntity);

      virtual WFMath::Vector<3>
      getMovementForCurrentFrame() const;

      MovementControllerMode::Mode
      getMode() const;

      void
      setCameraFreeFlying(bool freeFlying);

      bool
      isCameraFreeFlying() const;
    ...
    protected:
       ...
       */
      void
      entityPicker_PickedEntity(const EntityPickResult& result,
       ...
       */
      void
      createDecal(Ogre::Vector3 position);
