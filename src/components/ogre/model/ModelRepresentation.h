  ...
  namespace OgreView
  {
    ...
    namespace Model
    {
      ...
      public:
         ...
         */
        void
        updateAnimation(float timeSlice);
        ...
        getWorldBoundingBox(bool derive = true) const;
         ...
         */
        virtual const Ogre::Sphere &
        getWorldBoundingSphere(bool derive = true) const;
         ...
         */
        void
        setVisualize(const std::string& visualization, bool visualize);
         ...
         */
        bool
        getVisualize(const std::string& visualization) const;
         ...
         */
        void
        setModelPartShown(const std::string& partName, bool visible);
         ...
         */
        void
        setLocalVelocity(const WFMath::Vector<3>& velocity);
      ...
      protected:
         ...
         */
        void
        processOutfit(const Atlas::Message::MapType & outfitMap);

        void
        entity_Changed(const Eris::StringSet& attributeIds);

        void
        entity_TaskAdded(Eris::Task* task);
        void
        entity_TaskRemoved(Eris::Task* task);
         ...
         */
        void
        createActionForTask(const Eris::Task& task);
         ...
         */
        void
        attrChanged(const std::string& str, const Atlas::Message::Element& v);
        /**
         *    Overridden from Eris::Entity
         * @param act
         */
        void
        entity_Acted(const Atlas::Objects::Operation::RootOperation& act);
         ...
         */
        virtual void
        onMovementModeChanged(MovementMode newMode);
         ...
         */
        virtual void
        parseMovementMode(const WFMath::Vector<3>& velocity);
