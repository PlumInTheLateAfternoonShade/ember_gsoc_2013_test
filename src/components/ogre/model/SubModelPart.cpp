...
namespace Ember
{
  namespace OgreView
  {
    namespace Model
    {
      ...
      bool
      SubModelPart::addSubEntity(Ogre::SubEntity* subentity,
      ...
      bool
      SubModelPart::removeSubEntity(const Ogre::SubEntity* subentity)
      {
        for (SubModelPartEntityStore::iterator I = mSubEntities.begin();
            I != mSubEntities.end(); ++I)
          {
      ...
      SubModelPart::show()
      {
        for (SubModelPartEntityStore::const_iterator I = mSubEntities.begin();
            I != mSubEntities.end(); ++I)
          {
            if (I->Definition && I->Definition->getMaterialName() != "")
            ...
            else
              {
                ...
                I->SubEntity->setMaterialName(
                    I->SubEntity->getSubMesh()->getMaterialName());
              }
      ...
      const SubModelPart::SubModelPartEntityStore&
      SubModelPart::getSubentities() const
      {
        return mSubEntities;
      }
