...
namespace Ember
{
  namespace OgreView
  {
    namespace Model
    {
      ...
      Ogre::ParticleSystem*
      ParticleSystem::getOgreParticleSystem()
      {
      ...
      ParticleSystem::~ParticleSystem()
      {
        ...
        mOgreParticleSystem->_getManager()->destroyParticleSystem(
            mOgreParticleSystem);

      }

      ParticleSystemBindingsPtrSet&
      ParticleSystem::getBindings()
      {
        return mBindings;
      }

      ParticleSystemBinding *
      ParticleSystem::addBinding(const std::string & emitterVal,
          const std::string & variableName)
      {
        ParticleSystemBinding* binding = new ParticleSystemBinding(this,
            emitterVal, variableName);
        mBindings.push_back(binding);
        return binding;
      }

      void
      ParticleSystem::setVisible(bool visibility)
      {
      ...
      const Ogre::Vector3&
      ParticleSystem::getDirection() const
      {
        return mDirection;
      }
