...
namespace Ember
{
  namespace OgreView
  {
    namespace Model
    {
      ...
      public:
        const std::string&
        getSubEntityName() const;
        unsigned int
        getSubEntityIndex() const;

        const std::string&
        getMaterialName() const;
        void
        setMaterialName(const std::string& materialName);

        const PartDefinition&
        getPartDefinition() const;

      private:
        SubEntityDefinition(const std::string& subEntityName,
            PartDefinition& partdef);
        SubEntityDefinition(unsigned int subEntityIndex,
            PartDefinition& partdef);
      ...
      public:
        ...
        SubEntityDefinition*
        createSubEntityDefinition(const std::string& subEntityName);
        SubEntityDefinition*
        createSubEntityDefinition(unsigned int subEntityIndex);
        const SubEntityDefinitionsStore&
        getSubEntityDefinitions() const;
        void
        removeSubEntityDefinition(SubEntityDefinition* def);

        const SubModelDefinition&
        getSubModelDefinition() const;

      private:
        PartDefinition(const std::string& name,
      ...
      public:
        ...
        PartDefinition*
        createPartDefinition(const std::string& partname);
        const PartDefinitionsStore&
        getPartDefinitions() const;
        void
        removePartDefinition(PartDefinition* def);

        const ModelDefinition&
        getModelDefinition() const;

      private:
        SubModelDefinition(const std::string& meshname,
      ...
      public:
        ~AnimationDefinition();
        AnimationPartDefinition*
        createAnimationPartDefinition(const std::string& ogreAnimationName);
        const AnimationPartDefinitionsStore&
        getAnimationPartDefinitions() const;
        void
        removeAnimationPartDefinition(AnimationPartDefinition* def);
      ...
      public:
        ...
        AnimationDefinition*
        createAnimationDefinition(int iterations = 1);
        const AnimationDefinitionsStore&
        getAnimationDefinitions() const;
        AnimationDefinitionsStore&
        getAnimationDefinitions();
        void
        removeAnimationDefinition(AnimationDefinition* def);

        SoundDefinition*
        createSoundDefinition(const std::string& groupName, unsigned int play);
        const SoundDefinitionsStore&
        getSoundDefinitions() const;
        SoundDefinitionsStore&
        getSoundDefinitions();
        void
        removeSoundDefinition(SoundDefinition* def);

        ActivationDefinition*
        createActivationDefinition(const ActivationDefinition::Type& type,
            const std::string& trigger);
        const ActivationDefinitionStore&
        getActivationDefinitions() const;
        ActivationDefinitionStore&
        getActivationDefinitions();
        void
        removeActivationDefinition(ActivationDefinition* def);

        const std::string&
        getName() const;
        Ogre::Real
        getAnimationSpeed() const;
        void
        setAnimationSpeed(Ogre::Real speed);
      ...
      public:
        ...
        ModelDefinition(Ogre::ResourceManager* creator,
            ...
            const Ogre::String& group, bool isManual = false,
        ...
        getUseScaleOf() const;
        void
        setUseScaleOf(const UseScaleOf useScale);
        ...
        getTranslate() const;
        void
        setTranslate(const Ogre::Vector3 translate);
         ...
         */
        bool
        getShowContained() const;
        void
        setShowContained(bool show);
         ...
         */
        float
        getRenderingDistance() const;
        void
        setRenderingDistance(float distance);
         ...
         */
        const Ogre::Vector3&
        getContentOffset() const;
        void
        setContentOffset(const Ogre::Vector3&);
         ...
         */
        void
        setRotation(const Ogre::Quaternion rotation);
         ...
         */
        SubModelDefinition*
        createSubModelDefinition(const std::string& meshname);
         ...
         */
        void
        removeSubModelDefinition(SubModelDefinition* def);
         ...
         */
        ActionDefinition*
        createActionDefinition(const std::string& actionname);

        /**
         * @brief Returns all ActionDefinitions defined.
         * @return
         */
        const ActionDefinitionsStore&
        getActionDefinitions() const;

        /**
         * @brief Returns all ActionDefinitions defined.
         * @return
         */
        ActionDefinitionsStore&
         ...
         */
        void
        removeActionDefinition(ActionDefinition* def);

        /**
         * @brief Gets all attach point definitions.
         * @return All attach point definitions.
         */
        const AttachPointDefinitionStore&
        getAttachPointsDefinitions() const;
         ...
         */
        void
        addAttachPointDefinition(const AttachPointDefinition& definition);
         ...
         */
        ViewDefinition*
        createViewDefinition(const std::string& viewname);

        /**
         * @brief Returns all views defined.
         * @return
         */
        const ViewDefinitionStore&
        getViewDefinitions() const;
         ...
         */
        void
        removeViewDefinition(const std::string& name);
         ...
         */
        BoneGroupDefinition*
        createBoneGroupDefinition(const std::string& name);
         ...
         */
        void
        removeBoneGroupDefinition(const std::string& name);

        /**
         * @brief Returns all bone groups.
         * @return All bone groups.
         */
        const BoneGroupDefinitionStore&
        getBoneGroupDefinitions() const;
        ...
        template<typename T, typename T1>
          static void
          removeDefinition(T* def, T1& store);
        ...
        getRenderingDefinition() const;

        const PoseDefinitionStore&
        getPoseDefinitions() const;

        void
        addPoseDefinition(const std::string& name,
            const PoseDefinition& definition);

        void
        removePoseDefinition(const std::string& name);
      ...
      public:
        ...
        explicit
        ModelDefnPtr(ModelDefinition* rep) :
        ...
        ModelDefnPtr&
        operator=(const Ogre::ResourcePtr& r);
...
///implementations
      ...
      ModelDefinition::getContentOffset() const
      {
        return mContentOffset;
      }
      inline void
      ModelDefinition::setContentOffset(const Ogre::Vector3& offset)
      {
        mContentOffset = offset;
      }

      inline void
      ModelDefinition::setValid(bool valid)
      {
        mIsValid = valid;
      }

      inline size_t
      ModelDefinition::calculateSize(void) const
      {
        //TODO:implement this
        return 0;
      }
      ...
      inline Ogre::Real
      ModelDefinition::getScale() const
      {
        return mScale;
      }
      inline void
      ModelDefinition::setScale(Ogre::Real scale)
      {
        mScale = scale;
      }

      inline ModelDefinition::UseScaleOf
      ModelDefinition::getUseScaleOf() const
      {
        return mUseScaleOf;
      }
      inline void
      ModelDefinition::setUseScaleOf(const UseScaleOf useScale)
      {
        mUseScaleOf = useScale;
      }

      inline float
      ModelDefinition::getRenderingDistance() const
      {
        return mRenderingDistance;
      }

      inline void
      ModelDefinition::setRenderingDistance(float distance)
      {
        mRenderingDistance = distance;
      }

      inline const std::string&
      ModelDefinition::getIconPath() const
      {
        return mIconPath;
      }

      inline int
      AnimationDefinition::getIterations() const
      {
        return mIterations;
      }

      inline Ogre::Real
      ActionDefinition::getAnimationSpeed() const
      {
        return mAnimationSpeed;
      }
      inline void
      ActionDefinition::setAnimationSpeed(Ogre::Real speed)
      {
