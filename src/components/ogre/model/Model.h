  ...
  namespace OgreView
  {
    ...
    namespace Model
    {
      ...
      public:
         ...
         */
        virtual void
        _notifyManager(Ogre::SceneManager* man);

        static Model*
        createModel(Ogre::SceneManager& sceneManager,
         ...
         */
        Action*
        getAction(const std::string& name);
         ...
         */
        Action*
        getAction(const ActivationDefinition::Type type,
         ...
         */
        void
        showPart(const std::string& partName, bool hideOtherParts = true);
         ...
         */
        void
        hidePart(const std::string& partName,
            bool dontChangeVisibility = false);
        ...
        SubModel*
        getSubModel(size_t index);

        Ogre::AnimationState*
        getAnimationState(const Ogre::String& name);
        Ogre::AnimationStateSet*
        getAllAnimationStates();
        Ogre::SkeletonInstance *
        getSkeleton();
        Ogre::TagPoint*
        attachObjectToBone(const Ogre::String &boneName,
        ...
        Ogre::MovableObject *
        detachObjectFromBone(const Ogre::String &movableName);
        void
         ...
         */
        virtual void
        setRenderingDistance(Ogre::Real dist);
         ...
         */
        virtual void
        _notifyCurrentCamera(Ogre::Camera* cam);
         ...
         */
        virtual void
        setUserAny(const Ogre::Any &anything);

        /// Overridden - see MovableObject.
        virtual void
        setRenderQueueGroup(Ogre::RenderQueueGroupID queueID);
         ...
         */
        virtual const Ogre::AxisAlignedBox&
        getWorldBoundingBox(bool derive) const;
         ...
         */
        virtual void
        _updateRenderQueue(Ogre::RenderQueue* queue);
        ...
        /** Overridden from MovableObject */
        virtual void
        setQueryFlags(unsigned long flags);

        /** Overridden from MovableObject */
        virtual void
        addQueryFlags(unsigned long flags);

        /** Overridden from MovableObject */
        virtual void
        removeQueryFlags(unsigned long flags);

        /** Overridden from MovableObject */
        virtual void
        _notifyAttached(Ogre::Node* parent, bool isTagPoint = false);
         ...
         */
        virtual void
        visitRenderables(Ogre::Renderable::Visitor* visitor,
        ...
        AttachPointWrapper
        attachObjectToAttachPoint(const Ogre::String &attachPointName,
        ...
        bool
        hasAttachPoint(const std::string& attachPoint) const;

        const ParticleSystemBindingsPtrSet&
        getAllParticleSystemBindings() const;
         ...
         */
        const AttachPointWrapperStore*
        getAttachedPoints() const;
         ...
         */
        void
        setDisplaySkeleton(bool display);
      ...
      protected:
         ...
         */
        bool
        create(const std::string& modelType); // create model of specific type
         ...
         */
        void
        iterateOverMovableObjects(std::function<void
...
// }
      ...
      inline ModelDefinitionPtr
      Model::getDefinition() const
      {
        return mDefinition;
      }
...
// // }
      ...
      inline const Model::SubModelSet&
      Model::getSubmodels() const
      {
        return mSubmodels;
      }
      ...
      public:
        ...
        getType(void) const;
        void
        destroyInstance(Ogre::MovableObject* obj);
