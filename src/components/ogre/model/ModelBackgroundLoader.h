  ...
  namespace OgreView
  {
    ...
    namespace Model
    {
      ...
      public:
         ...
         */
        virtual void
        operationCompleted(Ogre::BackgroundProcessTicket ticket,
      ...
      public:
        ...
        typedef std::list<Ogre::BackgroundProcessTicket,
            Ogre::STLAllocator<Ogre::BackgroundProcessTicket,
                Ogre::CategorisedAlignAllocPolicy<Ogre::MEMCATEGORY_GENERAL>> > TicketStore;
         ...
         */
        bool
        poll(const TimeFrame& timeFrame);
      ...
      protected:
         ...
         */
        void
        addTicket(Ogre::BackgroundProcessTicket ticket);
        ...
        operationCompleted(Ogre::BackgroundProcessTicket ticket,
            const Ogre::BackgroundProcessResult& result,
            ModelBackgroundLoaderListener* listener);
         ...
         */
        bool
        isThereTimeLeft(long long maxTimeMilliseconds);
