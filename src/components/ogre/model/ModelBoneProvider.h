  ...
  namespace OgreView
  {
    namespace Model
    {
      ...
      public:
         ...
         */
        ModelBoneProvider(Model& parentModel,
        ...
        createChildProvider(Ogre::MovableObject* attachedObject = 0);
        virtual void
         ...
         */
        virtual void
        setPositionAndOrientation(const Ogre::Vector3& position,
