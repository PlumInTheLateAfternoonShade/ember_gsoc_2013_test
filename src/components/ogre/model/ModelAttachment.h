    ...
    namespace Model
    {
      ...
      public:
        ...
        ModelAttachment(EmberEntity& parentEntity,
            ...
            INodeProvider* nodeProvider, const std::string& pose = "");
        ...
        getGraphicalRepresentation() const;

        virtual IEntityAttachment*
        attachEntity(EmberEntity& entity);
        ...
        virtual void
        getOffsetForContainedNode(const IEntityAttachment& attachment,
         ...
         */
        virtual void
        setPosition(const WFMath::Point<3>& position,
      ...
      protected:
        ...
        void
        entity_AttrChanged(const Atlas::Message::Element& attributeValue,
            const std::string& fittingName);
        void
        fittedEntity_BeingDeleted(EmberEntity* entity);
         ...
         */
        void
        detachFitting(EmberEntity& entity);
         ...
         */
        void
        createFitting(const std::string& fittingName,
