  ...
  namespace EntityMapping
  {
    ...
    namespace Actions
    {
      ...
      public:
         ...
         */
        virtual void
        activate(ChangeContext& context) = 0;

        /**
         * Deactivate the action.
         */
        virtual void
        deactivate(ChangeContext& context) = 0;
         ...
         */
        void
        setCase(Cases::CaseBase* ownerCase);
      ...
      inline void
      Action::setCase(Cases::CaseBase* ownerCase)
      {
        mOwnerCase = ownerCase;
      }

      inline Cases::CaseBase*
      Action::getCase() const
      {
        return mOwnerCase;
      }
