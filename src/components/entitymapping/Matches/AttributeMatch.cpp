...
namespace Ember
{
  ...
  namespace EntityMapping
  {
    ...
    namespace Matches
    {
      ...
      AttributeMatch::AttributeMatch(const std::string& attributeName,
          const std::string& internalAttributeName) :
          mAttributeName(attributeName), mInternalAttributeName(
              internalAttributeName)
      {
      }

      void
      AttributeMatch::testAttribute(const Atlas::Message::Element& attribute,
      ...
      void
      AttributeMatch::setEntity(Eris::Entity* entity)
      {
