...
namespace Ember
{
   ...
   */
  class LoggedInState : public virtual StateBase<EnteredWorldState>,
  ...
  public:
    ...
    void
    runCommand(const std::string &, const std::string &);
  ...
  private:
    ...
    void
    gotAvatarSuccess(Eris::Avatar* avatar);

    void
    gotAvatarDeactivated(Eris::Avatar* avatar);

    void
    gotCharacterInfo(const Atlas::Objects::Entity::RootEntity& characterInfo);
     ...
     */
    void
    avatar_transferRequest(const Eris::TransferInfo& transferInfo,
        const Eris::Avatar* avatar);
     ...
     */
    void
    removeTransferInfo(const AvatarTransferInfo& transferInfo);
