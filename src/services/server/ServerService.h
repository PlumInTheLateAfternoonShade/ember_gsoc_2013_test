...
namespace Ember
{
  ...
  public:
    ...
    bool
    connect(const std::string& host, short port = 6767);
     ...
     */
    void
    takeTransferredCharacter(const Eris::TransferInfo& transferInfo);
     ...
     */
    void
    takeCharacter(const std::string &id);
     ...
     */
    bool
    createCharacter(const std::string& name, const std::string& sex,
...
//	Eris::View* getView() const;
     ...
     */
    void
    moveToPoint(const WFMath::Point<3>& dest);
     ...
     */
    void
    moveInDirection(const WFMath::Vector<3>& velocity,
     ...
     */
    void
    sayTo(const std::string &message,
        const std::vector<const Eris::Entity*>& entities);
     ...
     */
    void
    sayTo(const std::string &message, const Eris::Entity& entity);
     ...
     */
    void
    emote(const std::string& emote);
    void
    drop(Eris::Entity* entity,
        const WFMath::Vector<3>& offset = WFMath::Vector<3>::ZERO(),
        const WFMath::Quaternion& orientation = WFMath::Quaternion());
    void
    place(Eris::Entity* entity, Eris::Entity* target,
        const WFMath::Point<3>& pos = WFMath::Point<3>::ZERO());
    void
    place(Eris::Entity* entity, Eris::Entity* target,
        const WFMath::Point<3>& pos, const WFMath::Quaternion& orientation);
    void
    wield(Eris::Entity* entity, const std::string& outfitSlot = "");
    void
    take(Eris::Entity* entity);
     ...
     */
    void
    use(Eris::Entity* entity, WFMath::Point<3> pos = WFMath::Point<3>::ZERO(),
    ...
    void
    actuate(Eris::Entity* entity, const std::string& action);
    void
    attack(Eris::Entity* entity);
    void
    eat(Eris::Entity* entity);
    void
    deleteEntity(Eris::Entity* entity);
    void
    setAttributes(Eris::Entity* entity, Atlas::Message::MapType& attributes);
    void
    adminTell(const std::string& entityId, const std::string& attribute,
     ...
     */
    void
    createTypeInfo(const Atlas::Objects::Root& typeInfo);
     ...
     */
    void
    setTypeInfo(const Atlas::Objects::Root& typeInfo);

  private:

    void
    gotConnection(Eris::Connection* connection);

    void
    gotAvatar(Eris::Avatar* avatar);

    void
    gotAccount(Eris::Account* account);
