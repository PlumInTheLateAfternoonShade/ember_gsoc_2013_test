...
// 	const ConsoleCommandWrapper MetaList;
  ...
  public:
    ...
    void
    gotFailure(const std::string& msg);

    void
    receivedServerInfo(const Eris::ServerInfo& sInfo);

    void
    completedServerList(int count);
     ...
     */
    static int
    compareVersions(const std::string& firstVersion,
