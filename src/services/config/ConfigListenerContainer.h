...
namespace Ember
{
  ...
  {
  public:
    typedef sigc::slot<void, const std::string&, const std::string&,
        varconf::Variable&> SettingChangedSlot;

    virtual
    ~ConfigListenerContainer();
     ...
     */
    ConfigListener*
    registerConfigListener(const std::string& section, const std::string& key,
        SettingChangedSlot slot, bool evaluateNow = true);
     ...
     */
    ConfigListener*
    registerConfigListenerWithDefaults(const std::string& section,
        const std::string& key, SettingChangedSlot slot,
