...
namespace Ember
{
  ...
  public:
    ...
    evaluate();
  protected:
    ConfigListener(const std::string& section, const std::string& key,
        ConfigListenerContainer::SettingChangedSlot slot);
    ...
    void
    ConfigService_EventChangedConfigItem(const std::string& section,
