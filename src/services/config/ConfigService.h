...
namespace Ember
{
  ...
  private:
     ...
     */
    void
    updatedConfig(const std::string& section, const std::string& key);

    void
    configError(const char* error);
  ...
  public:
    ...
    bool
    getValue(const std::string& section, const std::string& key,
        varconf::Variable& value) const;
     ...
     */
    void
    setValue(const std::string& section, const std::string& key,
        const varconf::Variable& value, int scope = varconf::INSTANCE);
     ...
     */
    virtual void
    runCommand(const std::string &command, const std::string &args);
     ...
     */
    bool
    itemExists(const std::string& section, const std::string& key) const;
     ...
     */
    bool
    hasItem(const std::string& section, const std::string& key) const;

    /**
     Returns true if the item is set to the supplied value.
     */
    bool
    isItemSet(const std::string& section, const std::string& key,
     ...
     */
    bool
    deleteItem(const std::string& section, const std::string& key);
     ...
     */
    bool
    loadSavedConfig(const std::string& filename,
        const StringConfigMap& commandLineSettings = StringConfigMap());
     ...
     */
    bool
    saveConfig(const std::string& filename,
        int scopeMask = varconf::GLOBAL | varconf::USER | varconf::INSTANCE);
     ...
     */
    const std::string&
    getSharedConfigDirectory() const;
     ...
     */
    void
    setHomeDirectory(const std::string& path);
