...
namespace Ember
{
  ...
  public:
     ...
     */
    virtual void
    onNewMessage(const std::string & message, const std::string & file,
        const int & line, const Log::MessageImportance & importance);
  ...
  private:
     ...
     */
    StreamLogObserver &
    operator=(const StreamLogObserver &source);
