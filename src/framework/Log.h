...
namespace Ember
{
  ...
  public:
    ...
    static void
    log(const char *file, const char *message, ...);

    static void
    log(const char *file, const int line, const char *message, ...);

    static void
    log(const MessageImportance importance, const char *message, ...);

    static void
    log(const char *file, const MessageImportance importance,
        const char *message, ...);

    static void
    log(const char *file, const int line, const MessageImportance importance,
        const char *message, ...);
     ...
     */
    static void
    logVarParam(const char *file, const int line,
    ...
    slog(const std::string & file, const int line,
    ...
    static LoggingInstance
    slog(const std::string & file, const MessageImportance importance);

    static LoggingInstance
    slog(const std::string & file, const int line);

    static LoggingInstance
    slog(const std::string & file);
     ...
     */
    static int
    removeObserver(LogObserver * observer);
     ...
     */
    static void
    sendMessage(const std::string & message, const std::string & file,
        const int line, const MessageImportance importance);
