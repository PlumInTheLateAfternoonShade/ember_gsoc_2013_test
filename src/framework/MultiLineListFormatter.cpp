...
namespace Ember
{
  ...
  void
  MultiLineListFormatter::mapListItem(const std::string & name)
  {
  ...
  void
  MultiLineListFormatter::listMapItem()
  {
  ...
  void
  MultiLineListFormatter::listListItem()
  {
    m_stream << std::string(m_indent, ' ');
  ...
  void
  MultiLineListFormatter::listIntItem(long l)
  {
    m_stream << std::string(m_indent, ' ');
  ...
  void
  MultiLineListFormatter::listFloatItem(double d)
  {
    m_stream << std::string(m_indent, ' ');
  ...
  void
  MultiLineListFormatter::listStringItem(const std::string&s)
  {
    m_stream << std::string(m_indent, ' ');
  ...
  void
  MultiLineListFormatter::listEnd()
  {
    m_indent -= m_spacing;
    m_stream << std::string(m_indent, ' ');
