...
namespace Ember
{
  ...
  namespace Tasks
  {
    ...
    TaskUnit::~TaskUnit()
    {
      for (SubtasksStore::iterator I = mSubtasks.begin(); I != mSubtasks.end();
          ++I)
        {
          delete *I;
        }
    ...
    TaskUnit*
    TaskUnit::addSubtask(ITask* task, ITaskExecutionListener* listener)
    {
    ...
    const TaskUnit::SubtasksStore&
    TaskUnit::getSubtasks() const
    {
      return mSubtasks;
    }

    void
    TaskUnit::executeInBackgroundThread(TaskExecutionContext& context)
    {
#ifdef LOG_TASKS
          ...
          if (mListener)
            {
              ...
              mListener->executionError(
                  Exception("Error when executing task."));
            }
        }
      catch (...)
        {
    ...
    TaskUnit::executeInMainThread()
    {
      ...
      for (SubtasksStore::const_iterator I = mSubtasks.begin();
          I != mSubtasks.end(); ++I)
        {
